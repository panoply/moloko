...
[\xC6sthetic Documentation](https://\xE6sthetic.dev/rules/global/correct/)`},language:{enum:["auto","text","html","liquid","javascript","jsx","typescript","tsx","json","css","scss","less","xml"],default:"auto",markdownDescription:`The name of the language provided. This option can be omitted when using \xC6sthetic within text editors as languages are automatically assigned based on file.
...
`;var b;function ge(e){return M(this,null,function*(){oe(e),b=yield import(T(e,"monaco/monaco.js")),b.editor.defineTheme("potion",de),b.editor.defineTheme("potion-light",ce),b.editor.setTheme("potion"),b.languages.setMonarchTokensProvider("liquid",me),b.languages.setLanguageConfiguration("liquid",ue),b.languages.html.registerHTMLLanguageService("liquid"),b.languages.register({id:"liquid",extensions:[".liquid"],aliases:["Liquid","liquid"],mimetypes:["text/liquid"]}),self.MonacoEnvironment={getWorkerUrl:(t,i)=>{switch(i){case"json":return T(e,"monaco/workers","json.js");case"css":case"scss":case"less":return T(e,"monaco/workers","css.js");case"html":case"xml":case"liquid":return T(e,"monaco/workers","html.js");case"javascript":case"typescript":case"jsx":case"tsx":return T(e,"monaco/workers","typescript.js");default:return T(e,"monaco/workers","editor.js")}}};})}function H(e,t=fe){return b.editor.createModel(t,e)}function J(e,t){let i;return t?i=JSON.stringify(t,null,2):i=JSON.stringify({crlf:!1,correct:!1,preset:"default",language:e,endNewline:!1,indentChar:" ",indentLevel:0,indentSize:2,preserveLine:2,wrap:0,wrapFraction:0,liquid:{commentNewline:!1,commentIndent:!0,delimiterTrims:"preserve",delimiterPlacement:"preserve",forceFilter:0,forceArgument:0,ignoreTagList:[],indentAttribute:!1,lineBreakSeparator:"before",normalizeSpacing:!0,preserveComment:!1,preserveInternal:!1,dedentTagList:[],quoteConvert:"none"},markup:{attributeCasing:"preserve",attributeSort:!1,commentNewline:!1,commentDelimiters:"force",commentIndent:!0,delimiterTerminus:"inline",forceAttribute:3,forceIndent:!1,ignoreCSS:!1,ignoreJS:!0,ignoreJSON:!1,lineBreakValue:"preserve",preserveComment:!1,preserveText:!1,preserveAttribute:!1,selfCloseSpace:!0,selfCloseSVG:!0,stripAttributeLines:!1,quoteConvert:"none"},json:{arrayFormat:"default",braceAllman:!1,bracePadding:!1,objectIndent:"default",objectSort:!1},style:{commentIndent:!1,commentNewline:!1,atRuleSpace:!0,classPadding:!1,noLeadZero:!1,preserveComment:!1,sortSelectors:!1,sortProperties:!1,quoteConvert:"none",correct:!1},script:{arrayFormat:"default",braceNewline:!1,bracePadding:!1,braceStyle:"none",braceAllman:!1,caseSpace:!1,commentIndent:!1,commentNewline:!1,elseNewline:!1,endComma:"never",functionNameSpace:!1,functionSpace:!1,inlineReturn:!0,methodChain:4,neverFlatten:!1,noCaseIndent:!1,noSemicolon:!1,objectSort:!1,objectIndent:"default",preserveComment:!1,quoteConvert:"none",styleGuide:"none",ternaryLine:!1,variableList:!0,vertical:!1}},null,2),b.languages.json.jsonDefaults.setDiagnosticsOptions({validate:!0,enableSchemaRequest:!0,schemas:[{uri:"http://myserver/foo-schema.json",fileMatch:["*"],schema:he}]}),b.editor.createModel(i,"json")}var be=({attrs:e})=>{let t=Object.assign({},e.config.monaco);return t.model=e.input.model,b.languages.registerDocumentRangeFormattingEditProvider({language:e.input.model.getLanguageId()},{provideDocumentRangeFormattingEdits:i=>[{text:g.format(i.getValue()),range:i.getFullModelRange()}]}),e.input.model.onDidChangeContent(()=>{e.preview.state===3?(F(e),e.hash!==null&&D(e)):e.hash!==null&&D(e);}),{oncreate:({dom:i})=>{e.input.editor=b.editor.create(i,t),e.input.editor.addCommand(b.KeyMod.CtrlCmd|b.KeyCode.KeyS,()=>{e.input.editor.trigger("editor","editor.action.formatDocument",null);});},view:()=>r("div",{style:{height:"100%"}})}};var $={oncreate:({dom:e,attrs:t})=>{let i=Object.assign({},t.config.monaco);i.model=t.preview.model,i.lineNumbers="on",i.readOnly=!0,i.renderLineHighlight="none",i.cursorStyle="line-thin",t.preview.editor=b.editor.create(e,i),t.input.editor.onDidScrollChange(({scrollLeft:o,scrollTop:s})=>{t.preview.editor.setScrollPosition({scrollLeft:o,scrollTop:s},0);});},onremove:({attrs:e,dom:t})=>{e.preview.width=t.clientWidth,e.preview.editor.dispose();},view:()=>r("div",{style:{height:"100%"}})};function we(e,t){let i=Object.assign({},t.config.monaco);return i.model=t.esthetic.model,i.automaticLayout=!1,b.languages.registerDocumentRangeFormattingEditProvider({language:"json"},{provideDocumentRangeFormattingEdits:o=>[{text:g.json(o.getValue()),range:o.getFullModelRange()}]}),{mount:()=>{t.esthetic.editor=b.editor.create(e,i),t.esthetic.editor.updateOptions({theme:"potion-light"}),t.esthetic.editor.addCommand(b.KeyMod.CtrlCmd|b.KeyCode.KeyS,()=>{g.rules(JSON.parse(t.esthetic.model.getValue())),t.esthetic.editor.trigger("editor","editor.action.formatDocument",null),t.input.editor.trigger("editor","editor.action.formatDocument",null);});},unmount:()=>{t.esthetic.editor.dispose();}}}var V=({attrs:e})=>{let t=Object.assign({},e.config.monaco);t.model=e.esthetic.model,t.automaticLayout=!1,b.languages.registerDocumentRangeFormattingEditProvider({language:e.esthetic.model.getLanguageId()},{provideDocumentRangeFormattingEdits:o=>[{text:g.json(o.getValue()),range:o.getFullModelRange()}]});let i=()=>{e.esthetic.editor.addCommand(b.KeyMod.CtrlCmd|b.KeyCode.KeyS,()=>{e.esthetic.rules=JSON.parse(e.esthetic.model.getValue()),g.rules(e.esthetic.rules),D(e),e.esthetic.editor.trigger("editor","editor.action.formatDocument",null),e.input.editor.trigger("editor","editor.action.formatDocument",null);});};return {oncreate:({dom:o})=>{e.esthetic.editor=b.editor.create(o,t),e.esthetic.editor.onDidFocusEditorText(()=>i());let{style:s}=e.esthetic.editor.getDomNode();s.setProperty("--vscode-editor-background","#121418"),s.setProperty("--vscode-editorGutter-background","#121418");},view:()=>r("div",{style:{height:"100%"}})}};var ye={view:({attrs:e})=>e.language.state!==1?[r(".language-label","Select Language"),[["text","Plain Text","#809abd"],["liquid","Liquid","#004999"],["html","HTML","#f16729"],["xml","XML","#f16729"],["css","CSS","#1472b6"],["scss","SCSS","#cd6699"],["json","JSON","#f5de1a"],["javascript","JavaScript","#f5de1a"],["typescript","TypeScript","#007acc"],["jsx","JSX","#00d8fe"],["tsx","TSX","#007acc"],["yaml","YAML","#fbc02d"]].map(([t,i,o])=>r('button.btn-language[type="button"]',{class:e.language.current===t?"current":"",style:`--moloko-accent: ${o}`,onclick:()=>{let s=e.input.model.getValue();e.input.model.dispose(),e.input.model=b.editor.createModel(s,t),e.input.editor.setModel(e.input.model),e.language.current=t,e.language.detect=!0;}},[r("span",i),N(t)]))]:null};var Pe=e=>e%2===0?"odd":"even",U=new Set,ve={oncreate:({attrs:e})=>{g.parse(e.input.model.getValue()),r.redraw();},view:({attrs:e})=>r("table.parse-table",{style:{width:`${e.preview.width}px`}},r("thead",r("tr",[r("th.index","Index"),r("th.number","Begin"),r("th.number","Ender"),r("th.number","Lines"),r("th.lexer","Lexer"),r("th.stack","Stack"),r("th.type","Type"),r("th.token","Token")])),r("tbody",g.table.begin.map((t,i)=>[r("tr",{id:`${i}`,class:`${g.table.lexer[i]} ${Pe(i)} ${U.has(i)?"active":""}`,onclick:()=>{U.clear();let o=g.table.begin[i],s=g.table.ender[i];for(let a=o;a<=s;a++)U.add(a);let u=o===-1?i>0?g.lines[i]:1:g.lines[o],n=s===i?g.lines[s]:i===-1?i>0?g.lines[i+1]:2:g.lines[s];e.input.editor.revealLineNearTop(u,0),e.input.editor.setSelection({startLineNumber:u,startColumn:0,endLineNumber:n,endColumn:0});}},[r("td.index",`${i}`),r("td.number",`${g.table.begin[i]}`),r("td.number",`${g.table.ender[i]}`),r("td.index",`${g.table.lines[i]}`),r("td.lexer",`${g.table.lexer[i]}`),r("td.stack",`${g.table.stack[i]}`),r("td.type",`${g.table.types[i]}`),r("td.token",r("pre",r("code",g.table.token[i])))])])))};function Be(e){if(g.settings({logColors:!1}),e.config.hash){let{hash:t}=window.location;t.charCodeAt(1)===77&&t.charCodeAt(2)===61&&(e.hash=t.slice(3));}else e.hash=null;if(e.hash){let t=X(e.hash);e.language=t.language,e.input.model=H(e.language.current,t.input.value),e.preview.model=H(e.language.current,t.input.value),e.input.width=t.input.width,e.preview.state=t.preview.state,e.preview.mode=t.preview.mode,e.preview.width=t.preview.width,e.esthetic.state=t.esthetic.state,e.esthetic.width=t.esthetic.width,e.esthetic.model=J(e.language.current,t.esthetic.rules),g.rules(t.esthetic.rules);}else return g.rules({language:e.language.current}),e.config.preview.enable&&(e.preview.model=H(e.language.current)),e.input.model=H(e.language.current),e.esthetic.model=J(e.language.current,e.esthetic.rules),e.config.hash&&(e.hash=D(e)),!0}function G(){return M(this,arguments,function*(e={}){let t=ne.update(e);yield ie(t);try{yield ge(t.path);}catch(o){throw new Error("Failed to load Monaco",o)}return Be(t)&&(yield re(2e3)),{get attrs(){return t},get esthetic(){return we}}})}function Re(i){return M(this,arguments,function*(e,t={}){let{attrs:o}=yield G(t);return {get attrs(){return o},Esthetic:V,Preview:$}})}function We(){return window.location.hash}function ze(i){return M(this,arguments,function*(e,t={}){let{attrs:o}=yield G(t),s=u=>o[u].state===3?".open":o[u].state===2?".close":"";return r.mount(e,{view:()=>r("section.moloko-editor",{style:{top:`${o.config.offset}px`}},[o.config.sidebar.enable?r("aside.moloko-sidebar",r(se,o)):null,r("aside.moloko-language"+s("language"),r(ye,o)),r("section.moloko-esthetic"+s("esthetic"),r(V,o)),r("section.moloko-input",r(be,o)),o.config.preview.enable&&o.preview.state===3?r(`section.moloko-preview[aria-label=${o.preview.mode===1?"preview":""}]`,o.preview.mode===1?r($,o):r(ve,o)):null])}),o})}
