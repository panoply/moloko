...
`;var g;function le(e){return C(this,null,function*(){ee(e),g=yield import(T(e,"monaco/monaco.js")),g.editor.defineTheme("potion",ne),g.editor.setTheme("potion"),g.languages.setMonarchTokensProvider("liquid",re),g.languages.setLanguageConfiguration("liquid",oe),g.languages.html.registerHTMLLanguageService("liquid"),g.languages.register({id:"liquid",extensions:[".liquid"],aliases:["Liquid","liquid"],mimetypes:["text/liquid"]}),self.MonacoEnvironment={getWorkerUrl:(t,n)=>{switch(n){case"json":return T(e,"monaco/workers","json.js");case"css":case"scss":case"less":return T(e,"monaco/workers","css.js");case"html":case"xml":case"liquid":return T(e,"monaco/workers","html.js");case"javascript":case"typescript":case"jsx":case"tsx":return T(e,"monaco/workers","typescript.js");default:return T(e,"monaco/workers","editor.js")}}};})}function E(e,t=se){return g.editor.createModel(t,e)}function z(e){let t=JSON.stringify(e&&v.rules(),null,2);return g.languages.json.jsonDefaults.setDiagnosticsOptions({validate:!0,enableSchemaRequest:!0,schemas:[{uri:"http://myserver/foo-schema.json",fileMatch:["*"],schema:ae}]}),g.editor.createModel(t,"json")}var de=({attrs:e})=>{let t=Object.assign({},e.config.monaco);return t.model=e.input.model,g.languages.registerDocumentRangeFormattingEditProvider({language:e.input.model.getLanguageId()},{provideDocumentRangeFormattingEdits:n=>[{text:v.format(n.getValue()),range:n.getFullModelRange()}]}),e.input.model.onDidChangeContent(()=>{e.preview.state===3?(_(e),e.hash!==null&&N(e)):e.hash!==null&&N(e);}),{oncreate:({dom:n})=>{e.input.editor=g.editor.create(n,t),e.input.editor.addCommand(g.KeyMod.CtrlCmd|g.KeyCode.KeyS,()=>{e.input.editor.trigger("editor","editor.action.formatDocument",null);});},view:()=>m("div",{style:{height:"100%"}})}};var Z={oncreate:({dom:e,attrs:t})=>{let n=Object.assign({},t.config.monaco);n.model=t.preview.model,n.lineNumbers="off",n.readOnly=!0,n.renderLineHighlight="none",n.cursorStyle="line-thin",t.preview.editor=g.editor.create(e,n),t.input.editor.onDidScrollChange(({scrollLeft:o,scrollTop:s})=>{t.preview.editor.setScrollPosition({scrollLeft:o,scrollTop:s},0);});},onremove:({attrs:e})=>{e.preview.editor.dispose();},view:()=>m("div",{style:{height:"100%"}})};function ce(e,t){g.editor.setTheme("potion-bg");let n=Object.assign({},t.config.monaco);return n.model=t.esthetic.model,n.options.automaticLayout=!1,g.languages.registerDocumentRangeFormattingEditProvider({language:"json"},{provideDocumentRangeFormattingEdits:o=>[{text:v.json(o.getValue()),range:o.getFullModelRange()}]}),{mount:()=>{t.esthetic.editor=g.editor.create(e,n),t.esthetic.editor.addCommand(g.KeyMod.CtrlCmd|g.KeyCode.KeyS,()=>{v.rules(JSON.parse(t.esthetic.model.getValue())),t.esthetic.editor.trigger("editor","editor.action.formatDocument",null),t.input.editor.trigger("editor","editor.action.formatDocument",null);});},unmount:()=>{t.esthetic.editor.dispose();}}}var J=({attrs:e})=>{let t=Object.assign({},e.config.monaco);return t.model=e.esthetic.model,t.automaticLayout=!1,g.languages.registerDocumentRangeFormattingEditProvider({language:"json"},{provideDocumentRangeFormattingEdits:n=>[{text:v.json(n.getValue()),range:n.getFullModelRange()}]}),{oncreate:({dom:n,attrs:o})=>{o.esthetic.editor=g.editor.create(n,t),o.esthetic.editor.addCommand(g.KeyMod.CtrlCmd|g.KeyCode.KeyS,()=>{v.rules(JSON.parse(o.esthetic.model.getValue())),o.esthetic.editor.trigger("editor","editor.action.formatDocument",null),o.input.editor.trigger("editor","editor.action.formatDocument",null);});},onremove:({attrs:n})=>{n.esthetic.editor.dispose();},view:()=>m("div",{style:{height:"100%"}})}};var pe={view:({attrs:e})=>e.language.state!==1?[m(".language-label","Select Language"),[["text","Plain Text","#809abd"],["liquid","Liquid","#004999"],["html","HTML","#f16729"],["xml","XML","#f16729"],["css","CSS","#1472b6"],["scss","SCSS","#cd6699"],["json","JSON","#f5de1a"],["javascript","JavaScript","#f5de1a"],["typescript","TypeScript","#007acc"],["jsx","JSX","#00d8fe"],["tsx","TSX","#007acc"],["yaml","YAML","#fbc02d"]].map(([t,n,o])=>m('button.btn-language[type="button"]',{class:e.language.current===t?"current":"",style:`--moloko-accent: ${o}`,onclick:()=>{let s=e.input.model.getValue();e.input.model.dispose(),e.input.model=g.editor.createModel(s,t),e.input.editor.setModel(e.input.model);}},[m("span",n),H(t)]))]:null};function je(e){if(v.config({logColors:!1}),e.config.hash){let{hash:t}=window.location;t.charCodeAt(1)===77&&t.charCodeAt(2)===61&&(e.hash=t.slice(3));}else e.hash=null;if(e.hash){let t=Y(e.hash);e.language=t.language,e.input.model=E(e.language.current,t.input.value),e.preview.model=E(e.language.current,t.input.value),e.input.width=t.input.width,e.preview.state=t.preview.state,e.preview.mode=t.preview.mode,e.preview.width=t.preview.width,e.esthetic.state=t.esthetic.state,e.esthetic.width=t.esthetic.width,e.esthetic.model=z(t.esthetic.rules),v.rules(t.esthetic.rules);}else v.rules({language:e.language.current}),e.config.preview.enable&&(e.preview.model=E(e.language.current)),e.input.model=E(e.language.current),e.esthetic.model=z(e.esthetic.rules);}function $(){return C(this,arguments,function*(e={}){let t=Q(e);yield K(t);try{yield le(t.path);}catch(n){throw new Error("Failed to load Monaco",n)}return je(t),{get attrs(){return t},get esthetic(){return ce}}})}function Ee(n){return C(this,arguments,function*(e,t={}){let{attrs:o}=yield $(t);return {get attrs(){return o},Esthetic:J,Preview:Z}})}function Ie(n){return C(this,arguments,function*(e,t={}){let{attrs:o}=yield $(t),s=d=>o[d].state===3?".open":o[d].state===2?".close":"";return m.mount(e,{view:()=>m("section.moloko-editor",{style:{top:`${o.config.offset}px`}},[o.config.sidebar.enable?m("aside.moloko-sidebar",m(te,o)):null,m("aside.moloko-language"+s("language"),m(pe,o)),m("section.moloko-esthetic"+s("esthetic"),m(J,o)),m("section.moloko-input",m(de,o)),o.config.preview.enable&&o.preview.state===3?m("section.moloko-preview",m(Z,o)):null])}),o})}
