...
var Ot = /\S/, ct = /\n/, ot = /^\s+$/;
var Ye = /\s+/g, pt = /^\s+/, Pe = /\s+$/;
var Xe = /^[\t\v\f\r \u00a0\u2000-\u200b\u2028-\u2029\u3000]+/, Ke = /[\t\v\f \u00a0\u2000-\u200b\u2028-\u2029\u3000]+$/, kt = /[\t\v\r \u00a0\u2000-\u200b\u2028-\u2029\u3000]+/g, Ai = /[\t\v\r \u00a0\u2000-\u200b\u2028-\u2029\u3000]/, ei = /^\n+/, ti = /\n+/g, Ni = /\W/;
var Bi = /\n(?!\s*\*)/;
var $i = /({%-?\s*(?:comment\s*-?%}|#)|<!-{2})\s*esthetic-ignore-(start|next|end)\b/, ii = /^\s*(\/[*/]|{%-?\s*(?:comment\s*-?%}|#)|<!-{2})\s*esthetic-ignore(?![a-z-][^-])/, Mt = /(\/[*/]|{%-?\s*(?:comment\s*-?%}|#)|<!-{2})\s*esthetic-ignore-start\b/, Dt = /^\/\/\s*esthetic-ignore-start\b/, ji = /^\/\*{1,2}(?:\s*|\n\s*\*\s*)esthetic-ignore-start\b/;
var Ei = /(\/[*/]|{%-?\s*(?:comment\s*-?%}|#)|<!--)\s*esthetic-ignore-next\b/, Pi = /^\s*[*-]\s/, It = /^\s*\d+\.\s/, ni = /^\s*(?:[*-]|\d+\.)\s/, si = /(?!=)\/?>$/, vt = /^<!--+/, Rt = /--+>$/, ri = /[a-zA-Z0-9_$#]+/, qt = /({%-?)(\s*)/, At = /(\s*)(-?%})/, Ti = /{%-?|-?%}/g;
var Nt = /#\s+|#/, Wi = /^{%-?\n|{%-?\s*#\n/, Mi = /\n\s*-?%}$/;
var Di = /comment\s*-?%}[\r\n]/;
var oi = /(\/|\\|\||\*|\[|\]|\{|\})/g;
...
var Ii = Object.defineProperty, _i = Object.defineProperties;
  ...
  return function u(N, l, O) {
    ...
    if (O && o === "object")
      if (Ne(O))
        ...
        for (let b in O) {
          let f = O[b];
          yn(f) ? l[b] = f(l[b], _e) : f === void 0 ? N ? l.splice(b, 1) : delete l[b] : f === null || tt(f) === !1 || Ne(f) ? l[b] = f : typeof l[b] == "object" ? l[b] = f === l[b] ? f : _e(l[b], f) : l[b] = u(!1, {}, f);
        }
    else
      o === "function" && (l = O(l, _e));
    return l;
...
function jt(e) {
  let s = r.count, n = r.stack.index, u = 0, N = 0, l = 0, O = 0, o = 0, b = 0, f = 0, t = !0, { count: h } = r, F = r.stack.token, le = r.stack.index, m = r.lineOffset, p = e.lexer[h] === "style", S = p && F === "global", I = p ? [";", "separator"] : [",", "separator"], D = [], d = {
    begin: [],
    ender: [],
    lexer: [],
    lines: [],
  ...
  do {
    if (e.begin[s] === n || S && s < O && i(e.token[s], 125) && e.begin[e.begin[s]] === -1) {
      if (e.types[s].indexOf("liquid") > -1)
        return;
      if (e.token[s] === I[0] || p === !0 && i(e.token[s], 125) && M(e.token[s + 1], 59) ? (t = !0, o = s + 1) : p === !0 && i(e.token[s - 1], 125) && (t = !0, o = s), o === 0 && e.types[0] === "comment")
        do
          o = o + 1;
        while (e.types[o] === "comment");
      else
        e.types[o] === "comment" && e.lines[o] < 2 && (o = o + 1);
      t === !0 && (e.token[s] === I[0] || p === !0 && i(e.token[s - 1], 125)) && o <= O && ((p === !0 && "};".indexOf(e.token[O]) < 0 || p === !1 && M(e.token[O], 44)) && (O = O + 1), D.push([o, O]), p === !0 && i(e.token[o], 125) ? O = o : O = o - 1);
    }
    s = s - 1;
  } while (s > n);
  if (D.length > 0 && D[D.length - 1][0] > s + 1) {
    if (u = D[D.length - 1][0] - 1, e.types[u] === "comment" && e.lines[u] > 1) {
      do
        u = u - 1;
  ...
  if (D.length > 1 && (p === !0 || r.language === "json" || i(e.token[s - 1], 61) || i(e.token[s - 1], 58) || i(e.token[s - 1], 40) || i(e.token[s - 1], 91) || i(e.token[s - 1], 44) || e.types[s - 1] === "word" || s === 0)) {
    D.sort(a), f = D.length, t = !1, n = 0;
    do {
      if (b = D[n][1], p === !0 && (l = b, e.types[l] === "comment" && (l = l - 1), i(e.token[l], 125) ? (b = b + 1, I[0] = "}", I[1] = "end") : (I[0] = ";", I[1] = "separator")), u = D[n][0], p === !0 && e.types[b - 1] !== "end" && e.types[b] === "comment" && e.types[b + 1] !== "comment" && n < f - 1 && (b = b + 1), u < b)
        do
          p === !1 && n === f - 1 && u === b - 2 && i(e.token[u], 44) && e.lexer[u] === "script" && e.types[u + 1] === "comment" || r.push(d, {
            ...
            token: e.token[u],
            types: e.types[u]
          }, c), N = N + 1, e.token[u] === I[0] && (p === !0 || e.begin[u] === e.begin[D[n][0]]) ? t = !0 : e.token[u] !== I[0] && e.types[u] !== "comment" && (t = !1), u = u + 1;
        while (u < b);
...
function ci(e, s, n) {
  return Ne(e) === !1 ? e : s === "normal" ? Zi.call({ array: e, recursive: n }, e) : s === "descend" ? Ui.call({ recursive: n }, e) : Ji.call({ recursive: n }, e);
}
function Qt(e, s) {
...
function Ji(e) {
  let s = 0, n = e.length, u = e, N = u.map((o) => o[1]), l = () => {
    ...
    if (o < b)
      do
        Ne(u[o]) === !0 && (u[o] = Ji.apply(this, u[o])), o = o + 1;
      while (o < b);
  }, O = (o = c) => {
...
function Ui(e) {
  let s = 0, n = e.length, u = e, N = () => {
    ...
    if (o < O)
      do
        Ne(u[o]) && (u[o] = Ui.apply(this, u[o])), o = o + 1;
      while (o < O);
  }, l = (O = "") => {
...
function Zi(e) {
  let s = e, n = [e[0]], u = () => {
    ...
    if (l < O)
      do
        Ne(s[l]) && (s[l] = Zi.apply(this, s[l])), l = l + 1;
      while (l < O);
  }, N = (l) => {
...
var Yi = (e) => Re.logColors ? `\x1B[93m${"^".repeat(e)}\x1B[39m` : `${"^".repeat(e)}`;
function xn(e) {
...
function wn(e = r.lineNumber) {
  ...
  do {
    ...
    l === u - 1 ? f.length === 0 ? s.push(`${" ".repeat(N + 2)} ${Yi(O.length)}`) : (Re.logColors ? s.push(`${b} \x1B[31m${f}\x1B[39m`) : s.push(`${b} ${f}`), s.push(`${" ".repeat(N + 2)} ${Yi(f.length)}`)) : Re.logColors ? s.push(`${b} \x1B[90m${f || "\u2424"}`) : s.push(`${b} ${f || "\u2424"}`), l = l + 1, O = f;
  } while (l < u);
  return s.join(H);
}
function qe(...e) {
...
function en(e, s, n = r.lineNumber) {
  return {
    105: {
      code: e,
...
function wt(e, s) {
  let n;
  ((ie) => (ie[ie.Force = 0] = "Force", ie[ie.Inline = 1] = "Inline", ie[ie.Preserve = 2] = "Preserve"))(n || (n = {}));
  let { start: u, lexer: N, end: l, ender: O } = s, { rules: o, data: b } = r, f = [], t = U(), h = s.begin.replace(oi, fi), F = t !== 4 ? h : `${s.begin}\\s*#`, le = new RegExp(`^(${F}\\s*esthetic-ignore-start)`), m = new RegExp(`^(${F}\\s*esthetic-ignore-next)`), p = new RegExp(r.crlf, "g"), S = new RegExp(`(${h})`), I = t > 2 ? new RegExp(s.ender.replace(Ti, zi)) : new RegExp(s.ender.replace(oi, fi)), D = u, d = 0, a = 0, g = c, W = s.ender.length - 1, C = s.ender.charAt(W);
  function U() {
  ...
  function j() {
    ...
    if (o.markup.commentDelimiters === "consistent")
      return i(g.slice(4).replace(Xe, c), 10) ? [0, 0] : [1, 1];
    ...
    if (o.markup.commentDelimiters === "preserve") {
      let L = [];
      return i(g.slice(4).replace(Xe, c), 10) ? L.push(0) : L.push(1), g.slice(g.lastIndexOf(H) + 1).trimStart() === s.ender ? L.push(0) : L.push(1), L;
    }
  }
  function x() {
    if (t === 1 && o.markup.preserveComment === !1)
      if (o.markup.commentDelimiters === "consistent") {
        ...
        L.slice(0, L.search(Ot)).indexOf(H) > -1 ? o.markup.commentIndent ? (g = g.replace(/^<!--\s*/, `<!--${H}  `), g = g.replace(/\s*-->$/, `${H}-->`)) : (g = g.replace(/^<!--\s*/, `<!--${H}`), g = g.replace(/\s*-->$/, `${H}-->`)) : (g = g.replace(/^<!--\s*/, "<!-- "), g = g.replace(/\s*-->$/, " -->"));
        ...
        let L = e.slice(u + 4).join(c);
        L.slice(0, L.search(Ot)).indexOf(H) > -1 ? o.markup.commentIndent ? g = g.replace(/^<!--\s*/, `<!--${H}  `) : g = g.replace(/^<!--\s*/, `<!--${H}`) : g = g.replace(/^<!--\s*/, "<!-- ");
        let ye = L.indexOf(O);
  ...
  function R(L) {
    ...
    return g = L.join(r.crlf), o.liquid.commentIndent === !1 && (g = g.replace(/^#/gm, " #")), [g, D];
  }
  function G() {
    let L = c;
    return g = f.join(c).replace(Ke, c), r.count > -1 && b.lines[r.count] > 0 && (d = e.lastIndexOf(H, r.iterator) + 1, d > 0 && (L = e.slice(d, r.iterator).join(c), L.trim() === c || (L = L.slice(0, L.search(Ot))), g = L + g)), [g, D];
  }
  function B() {
    let L = H;
    D = D + 1;
    do {
      if (f.push(e[D]), i(e[D], 10) && (r.lineOffset = r.lines(D, r.lineOffset)), e[D - 3] === "-" && e[D - 2] === "e" && e[D - 1] === "n" && e[D] === "d" && f.slice(f.length - 19).join(c) === "esthetic-ignore-end") {
        t === 3 && (a = e.indexOf("{", D), i(e[a + 1], 37) && (L = e.slice(a, e.indexOf("}", a) + 1).join(c), I.test(L) && (s.ender = L))), D = D + 1, L = c;
        break;
      }
      D = D + 1;
    } while (D < l);
    d = D, W = s.begin.length - 1, C = s.begin.charAt(W);
    do {
      if (t === 2 && i(e[d - 1], 47) && i(e[d], 42) || e[d] === C && e.slice(d - W, d + 1).join(c) === s.begin)
        break;
      d = d - 1;
    } while (d > u);
    if (t === 2 && i(e[d], 42) ? L = "*/" : L === c && t !== 2 && (L = s.ender), W = L.length - 1, C = L.charAt(W), M(L, 10) || M(e[D], 10))
      do {
        if (f.push(e[D]), i(L, 10) && i(e[D + 1], 10) || e[D] === C && e.slice(D - W, D + 1).join(c) === L)
          break;
        D = D + 1;
      } while (D < l);
    if (i(e[D], 10) && (D = D - 1), g = f.join(c).replace(Pe, c), ue(e[r.iterator - 1])) {
  ...
  function V() {
    ...
    if (t === 3 && o.liquid.preserveComment || t === 4 && o.liquid.preserveComment || t === 1 && o.markup.preserveComment) {
      if (d = e.lastIndexOf(H, r.iterator) + 1, d > 0) {
        ...
        L.trim() === c || (L = L.slice(0, L.search(Ot))), g = L + g;
      }
      return !0;
    }
    if (t === 2 && N === "style" && o.style.preserveComment || t === 2 && N === "script" && o.script.preserveComment || t !== 3 && t !== 4 && g.length <= o.wrap && g.indexOf(H) < 0 || o.wrap < 1 && t === 3 && Di.test(g) === !1)
      return !0;
    if (t === 4) {
      ...
      if (ct.test(g)) {
        if (Wi.test(g))
          return !1;
        if (Mi.test(g) && g.slice(g.indexOf("#") + 1, g.lastIndexOf(H)).indexOf(H) < 0)
          return o.wrap > 0 ? g = g.replace(ti, c).replace(qt, "$1 # ").replace(Nt, "# ").replace(At, " $2") : g = g.replace(ti, c).replace(qt, "$1 ").replace(Nt, "# ").replace(At, " $2"), !0;
      } else
        return o.wrap > 0 ? g = g.replace(qt, "$1 # ").replace(Nt, "# ").replace(At, " $2") : g = g.replace(qt, "$1 ").replace(Nt, "# ").replace(At, " $2"), !0;
      return !1;
    }
    return o.wrap > 0 && g.length <= o.wrap && g.slice(5, -4).indexOf(H) < 0 || o.wrap < 1 && t !== 3 && g.slice(5, -4).indexOf(H) < 0 || t === 2 && g.indexOf(H) > 0 && g.replace(H, c).indexOf(H) > 0 && Bi.test(g) === !1;
  }
  function ke() {
    let L = [], ye = 0;
...
${e.slice(d, u).join(c)}`, "g");
    return g = g.replace(p, H).replace(me, H), L = g.split(H), ye = L.length, L[0] = L[0].replace(S, c), L[ye - 1] = L[ye - 1].replace(I, c), t === 4 && o.wrap < 1 ? (L = L.map((ie) => ie.replace(/^#\s*/m, c).trimStart()), R(L)) : (ye < 2 && (L = L[0].split(te)), t === 3 ? L[0] === c ? L[0] = s.begin : L.splice(0, 0, s.begin) : L[0] === c ? L[0] = s.begin : L.splice(0, 0, s.begin), ye = L.length, t === 1 ? we(L, ye - 1) : ae(L, ye));
  }
  function we(L, ye) {
    let me = [L.shift()], ie = c, ce = 0;
    o.markup.commentDelimiters === "inline-align" ? ie = "     " : o.markup.commentIndent && (ie = "  ");
    let J = !1, P = 0;
    do {
      if (ot.test(L[ce]) === !0 || L[ce] === c)
        P = P + 1, P <= o.preserveLine && me.push(H);
      else if (J)
        me.push(L[ce].replace(Ke, c), H);
      else {
        let T = ce === 0 ? L[ce].trimStart().replace(Ke, c) : L[ce].trim();
        if (/<\/?[a-zA-Z]|{{|{%/.test(T))
          J = !0, me.push(L[ce].replace(Ke, c));
        else if (o.wrap > 0 && T.length > o.wrap) {
          let oe = T.replace(kt, " ").split(te).concat(H);
          for (let se = 0, ee = 0, _ = 0, Q = oe.length; se < Q; se++)
            _ += oe[se].length + 1, (_ > o.wrap || se + 1 === Q) && (me.push(ie + oe.slice(ee, se).join(te) + H), ee = se, _ = 0);
        } else
          me.push(`${ie}${T}${H}`);
      }
      ce = ce + 1;
    } while (ce < ye);
    return g = me.join(c) + te + s.ender, x();
  }
  function ae(L, ye) {
    let me = [], ie = 0, ce = 0, J, P, T = !1, oe = !1, se = !1, ee = !1;
    d = 0;
    do {
      if (P = d < ye - 1 ? L[d + 1].replace(Xe, c) : c, ot.test(L[d]) === !0 || L[d] === c) {
        if (ot.test(L[d + 1]) === !0 || L[d + 1] === c)
          do
            d = d + 1;
          while (d < ye && (ot.test(L[d + 1]) === !0 || L[d + 1] === c));
        d < ye - 1 && me.push(c);
      } else if (J = L[d].replace(Xe, c), o.wrap > 0 && J.length > o.wrap && J.indexOf(te) > o.wrap)
        L[d] = J, a = L[d].indexOf(te), me.push(L[d].slice(0, a)), L[d] = L[d].slice(a + 1), d = d - 1;
      else {
        if (t === 2 && L[d].indexOf("/*") !== 0 ? L[d] = Kt + L[d].replace(Xe, c).replace(Ke, c).replace(Ye, te) : L[d] = L[d].replace(Xe, c).replace(Ke, c), ce = d < 1 ? o.wrap - (s.begin.length + 1) : o.wrap, ie = L[d].replace(pt, c).indexOf(te), a = L[d].length, a > ce && ie > 0 && ie < ce) {
          a = ce;
          do
            if (a = a - 1, ue(L[d].charAt(a)) && a <= o.wrap)
              break;
          while (a > 0);
          It.test(L[d]) === !0 && It.test(L[d + 1]) === !1 && L.splice(d + 1, 0, "1. "), a < 4 ? (me.push(L[d]), ee = !0) : d === ye - 1 && (me.push(L[d].slice(0, a)), L[d] = L[d].slice(a + 1), ee = !0, d = d - 1), ot.test(L[d + 1]) === !0 || L[d + 1] === c ? (me.push(L[d].slice(0, a)), L[d] = L[d].slice(a + 1), T = !0, d = d - 1) : Pi.test(L[d + 1]) ? (me.push(L[d].slice(0, a)), L[d] = L[d].slice(a + 1), oe = !0, d = d - 1) : It.test(L[d + 1]) ? (me.push(L[d].slice(0, a)), L[d] = L[d].slice(a + 1), se = !0, d = d - 1) : L[d + 1].slice(0, 4) === Wt || a + P.length > o.wrap && P.indexOf(te) < 0 ? (me.push(L[d].slice(0, a)), L[d] = L[d].slice(a + 1), ee = !0, d = d - 1) : L[d].replace(Xe, c).indexOf(te) < o.wrap && (L[d].length > o.wrap ? L[d + 1] = `${L[d].slice(a + 1)}${r.crlf}${L[d + 1]}` : L[d + 1] = `${L[d].slice(a + 1)} ${L[d + 1]}`), T === !1 && oe === !1 && se === !1 && ee === !1 && (L[d] = L[d].slice(0, a));
        } else
          L[d + 1] !== void 0 && t < 3 && (L[d].length + P.indexOf(te) > o.wrap && P.indexOf(te) > 0 || L[d].length + P.length > o.wrap && P.indexOf(te) < 0) ? (me.push(L[d]), o.wrap > 0 && (d = d + 1), o.wrap < 1 && t === 3 && (d = d + 1), T = !0) : L[d + 1] !== void 0 && ot.test(L[d + 1]) === !1 && L[d + 1] !== c && L[d + 1].slice(0, 4) !== Wt && ni.test(L[d + 1]) === !1 && (t === 3 ? me.push(L[d]) : L[d + 1] = `${L[d]} ${L[d + 1]}`, T = !0);
        ee === !1 && oe === !1 && se === !1 && (T === !0 ? T = !1 : /^\s*(\*|-|(\d+\.))\s*$/.test(L[d]) === !1 && (d < ye - 1 && L[d + 1] !== c && ot.test(L[d]) === !1 && L[d + 1].slice(0, 4) !== Wt && ni.test(L[d + 1]) === !1 ? (L[d] = `${L[d]} ${L[d + 1]}`, L.splice(d + 1, 1), ye = ye - 1, d = d - 1) : t === 2 && L[d].indexOf("/*") !== 0 ? me.push(Kt + L[d].replace(Xe, c).replace(Ke, c).replace(Ye, te)) : me.push(L[d].replace(Xe, c).replace(Ke, c).replace(Ye, te)))), ee = !1, oe = !1, se = !1;
      }
      d = d + 1;
    } while (d < ye);
    let _ = j();
  ...
  do {
    if (i(e[D], 10) && (r.lineOffset = r.lines(D, r.lineOffset)), i(e[D], 35) && t === 4 && o.liquid.preserveComment === !1 && o.wrap > 0 && f.slice(f.lastIndexOf(H)).join(c).trim() === c ? f.push(te) : f.push(e[D]), e[D] === C && e.slice(D - W, D + 1).join(c) === s.ender) {
      t === 4 && i(e[D - 2], 45) && (s.ender = "-%}", I = new RegExp(s.ender)), g = f.join(c);
      break;
    }
    D = D + 1;
  } while (D < l);
  return le.test(g) ? B() : m.test(g) ? G() : V() ? x() : ke();
}
...
function Ht(e) {
  ...
  function b() {
    ...
    let h = 0, F = 0;
    if (l = l.replace(/\s+/g, te).replace(Pe, c), F = l.length, !(s > F)) {
      do {
        if (h = s, M(l[h], 32)) {
          do
            h = h - 1;
  ...
  if (u === e.end ? e.chars.push(H) : u = u - 1, l = O.join(c).replace(Pe, c), Dt.test(l) === !0) {
    let f = H;
    u = u + 1;
    do
      O.push(e.chars[u]), u = u + 1;
...
function tn(e, s) {
  ...
  return s.delimiterTrims === "never" ? N = `{${e[1]}` : s.delimiterTrims === "always" || s.delimiterTrims === "outputs" && i(e[1], 123) || s.delimiterTrims === "tags" && i(e[1], 37) ? N = `{${e[1]}-` : N = e.slice(0, n), s.delimiterPlacement === "preserve" ? N += /^\s*\n/.test(u) ? H : te : s.delimiterPlacement === "force" ? N += H : s.delimiterPlacement === "inline" || s.delimiterPlacement === "default" || s.delimiterPlacement === "force-multiline" ? N += te : s.delimiterPlacement === "consistent" && (/^\s*\n/.test(u) ? N += H : N += te), N + u.trim();
}
function zt(e, s, n = te) {
  let { delimiterTrims: u, delimiterPlacement: N } = r.rules.liquid, [l, O] = sn(e), o, b = e.slice(l, O), f;
...
function nn(e, s, n, {
  ...
  if (o === "never" ? (h = `{${e[1]}`, F = `${e[e.length - 2]}}`) : o === "always" || o === "outputs" && i(e[1], 123) || o === "tags" && i(e[1], 37) ? (h = `{${e[1]}-`, F = `-${e[e.length - 2]}}`) : o === "preserve" ? (h = e.slice(0, f).join(c), F = e.slice(t).join(c)) : (h = `{${e[1]}`, F = `${e[e.length - 2]}}`), s === "else" || s === "break" || s === "continue" || s === "increment" || s === "decrement" || s.startsWith("end"))
    return h += te, F = te + F, h + e.slice(f, t).join(c).trim() + F;
  if (b === "preserve" ? (h += i(e[f], 10) ? H : te, F = (i(e[t - 1], 10) ? H : te) + F) : b === "force" ? (h += H, F = H + F) : b === "inline" || b === "default" ? (h += te, F = te + F) : b === "consistent" ? i(e[f], 10) ? (h += H, F = H + F) : (h += te, F = te + F) : (h += te, F = te + F), s === "liquid")
    ...
    if (N > 0 && le >= N || N === 0 && u > 0 && e.length > u) {
      ...
      for (let m = 0; m < le; m++) {
        ...
        if (n.fargs[m] && (l > 0 && n.fargs[m].length >= l || l === 0 && u > 0 && e.slice(
          ...
          for (let I = 0; I < S; I++) {
            let D = n.fargs[m][I];
            O === "after" ? (Te(e[D + 1]) && Te(e[D + 2]) && (e[D + 1] = c), e[i(e[D - 1], 44) ? D - 1 : D] = I === 0 ? H + "  " : rt + H + " ") : O === "before" ? (Te(e[D + 1]) && Te(e[D + 2]) && (e[D + 1] = c), i(e[D - 1], 44) ? e[D - 1] = I === 0 ? "  " + H : H + "  " + rt : e[D] = I === 0 ? H + "  " : H + "  " + rt) : e[D] = H + "  " + e[D];
          }
        }
      }
    }
...
function un(e) {
  let { data: s, rules: n } = r, u = r.source, N = r.language === "jsx" || r.language === "tsx", l = new Set(n.liquid.ignoreTagList), O = Ne(n.markup.attributeSort) ? n.markup.attributeSort.length : -1, o = Ne(u) ? u : u.split(c), b = o.length, f = Fe(null);
  f.start = -1, f.tname = [], f.index = [];
  let t = 0, h, F = !1; r.language; let m = 0;
  function p(j) {
    let x = Fe(null);
    return x.lexer = "markup", x.lines = r.lineOffset, x.stack = r.stack.token !== "global" ? r.stack.token : "global", x.begin = r.stack.index, x.token = c, x.types = c, x.ender = -1, j ? dt(x, j) : x;
  }
  function S(j, x = c, R) {
    if (x === c && R === void 0)
      r.push(s, j, c);
      ...
      R ? (dt(j, R), r.push(s, j, x)) : console.log("isssue");
  }
  function I(j, x = null) {
    return r.language !== "html" && r.language !== "liquid" && N === !1 || /(?:{[=#/]|%[>\]])|\}%[>\]]/.test(j) || !Vt(j, 3) ? j : zt(j, x);
  }
  function D(j) {
    let x = j;
    do
  ...
  function a(j, x = c) {
    let R = o.slice(o.lastIndexOf(H, j) + 1, j);
    return Te(R[0]) ? (R = R.join(c), (R.trim() === c ? R : c) + x) : c + x;
  }
  function g(j, x = !0) {
    let R = j.indexOf("=");
    if (R > 0) {
      let G = j.indexOf(Be);
      if (R < G && G > 0)
        return x ? [j.slice(0, R), j.slice(R + 1)] : [j.slice(0, R), j.slice(R + 2, -1)];
      let B = j.indexOf($e);
      if (R < B && B > 0)
        return x ? [j.slice(0, R), j.slice(R + 1)] : [j.slice(0, R), j.slice(R + 2, -1)];
    }
  ...
  function W(j) {
    let x = p(), R = c, G = c, B = c, V = c, ke = c, we = !1, ae = !1, L = 0, ye = !1, me = !1, ie = !1, ce = !1, J = [];
    function P() {
      return A();
    }
    function T() {
      let q = u.indexOf("capture", t);
      if (o[q - 3] === "e" && o[q - 2] === "n" && o[q - 1] === "d")
        q = o.indexOf("}", q) + 1, x.types = B = "liquid_capture", x.token = R + u.slice(t, q), r.lineNumber = yt(R, r.lineNumber), S(x), t = q;
      else {
        let E = u.indexOf("endcapture", q + 7) + 9;
        if (E > -1 && /[a-z]/.test(o[E + 1]) === !1)
          return q = o.indexOf("}", E) + 1, R = R + u.slice(t, q), r.lineNumber = yt(R, r.lineNumber), t = q, T();
        De(114, R, V);
      }
    }
    function oe() {
      s.types[x.begin] === "start" && s.types[s.begin[x.begin]] === "liquid_start" && B === "liquid_end" ? (s.types[x.begin] = "singleton", delete r.pairs[r.stack.index]) : s.types[r.count] === "liquid_start" && B === "end" && (x.types = "singleton", delete r.pairs[r.stack.index], r.stack.pop());
    }
    function se() {
      if (x.types.indexOf("liquid") < 0)
        return oe(), P();
      if (x.token === c && (x.token = R), i(R[0], 123) && i(R[1], 37))
        if (Le.liquid.else.has(V))
          x.types = B = V === "when" ? "liquid_when" : "liquid_else";
        else if (Le.liquid.tags.has(V)) {
          if (F === !0)
            x.types = B = "liquid_start";
          else if (V === "capture")
            return t = t + 1, T();
          return x.types = B = V === "case" ? "liquid_case_start" : "liquid_start", A();
        } else if (V.startsWith("end")) {
          let q = V.slice(3);
          if (Le.liquid.tags.has(q))
            x.types = B = q === "case" ? "liquid_case_end" : "liquid_end";
          else {
            x.stack = q, x.types = B = "liquid_end";
            let E = 0;
            do {
              if (s.types[E] === "liquid" && s.stack[E] === q) {
                s.types[E] = "liquid_start";
                for (let z = E, Y = s.stack.length; z < Y; z++)
                  r.stack.push([s.token[z], z]);
                break;
              }
              E = s.stack.indexOf(q, E + 1);
            } while (E > -1);
          }
          oe();
        } else
          x.stack = V;
      return n.liquid.quoteConvert === "double" ? x.token = R = x.token.replace(/'[^"]*?'/g, ki(Be)) : n.liquid.quoteConvert === "single" && (x.token = R = x.token.replace(/"[^']*?"/g, ki($e))), P();
    }
    function ee() {
      let q = R.indexOf("liquid") + 6, E = c, z = c, Y = 1;
      S(x, {
        token: tn(R.slice(0, q), n.liquid),
        types: "liquid_start",
        stack: "liquid"
      });
      let Z = R.slice(q).split(H), fe = Z.pop().trim(), he = i(fe[fe.length - 3], 45) ? fe.length - 3 : fe.length - 2, xe = fe.slice(0, he), de = fe.slice(he);
      xe.length !== 0 && Z.push(xe), q = 0;
      do
        E = Z[q].trim(), z = E.split(/\s/)[0], z.startsWith("end") ? (x.token = E, x.types = z === "endcase" ? "liquid_case_end" : "liquid_end", x.lines = Y <= 1 ? 2 : Y, S(x), Y = 1) : z.startsWith("#") ? (x.token = E, x.types = "liquid", x.lines = Y <= 1 ? 2 : Y, S(x), Y = 1) : z.startsWith("comment") ? (x.token = E, x.types = "liquid_start", x.lines = Y, S(x), Y = 1) : Le.liquid.tags.has(z) ? (x.token = E, x.types = z === "case" ? "liquid_case_start" : "liquid_start", x.lines = Y, S(x), Y = 1) : Le.liquid.else.has(z) ? (x.token = E, x.types = z === "when" ? "liquid_when" : "liquid_else", x.lines = Y, S(x), Y = 1) : Le.liquid.singleton.has(z) ? (x.token = E, x.types = "liquid", x.lines = Y <= 1 ? 2 : Y, S(x), Y = 1) : E.trim().length > 0 && (x.token = E, x.types = "content", x.lines = Y, S(x), Y = 1), q = q + 1, Y = Y + 1;
      while (q < Z.length);
      n.liquid.delimiterPlacement === "default" || n.liquid.delimiterPlacement === "force-multiline" || n.liquid.delimiterPlacement === "preserve" && /\n-?%}$/.test(R) || n.liquid.delimiterPlacement === "consistent" && /^{%-?\n/.test(R) ? S(x, {
        token: de,
        types: "liquid_end",
        lines: 2
      }) : S(x, {
    ...
    function _() {
      if (V === "svg" && (f.start = r.count + 1, x.stack = V), Le.svg.tags.has(V) && f.start > -1) {
        if (x.types === "start")
          x.types = "singleton", x.stack = V, f.tname.push(V), f.index.push(r.count + 1);
        else if (x.types === "end") {
          let q = f.tname.indexOf(V), E = f.tname.lastIndexOf(V), z;
          if (q > -1)
            for (E === q ? (z = f.index[E], s.types[f.index[E]] = "start", f.tname.splice(E, 1), f.index.splice(E, 1)) : s.begin[r.count] === f.index[q] ? (z = s.begin[r.count], s.types[s.begin[r.count]] = "start", f.tname.splice(q, 1), f.index.splice(q, 1)) : (z = f.index[E], s.types[f.index[E]] = "start"); z < s.stack.length; z++)
    ...
    function Q() {
      return ce && ae === !1 && B !== "xml" && (Le.html.voids.has(V) ? (x.types = B = "singleton", M(R[R.length - 2], 47) && (x.token = d(R))) : i(R[R.length - 2], 47) && i(R[R.length - 1], 62) ? x.types = B = "singleton" : x.types = B = "start"), _();
    }
    function k(q, E) {
      let z = t, Y = -1, Z = 0, fe;
      do {
        ...
        if (E === 3) {
          if (i(o[t - 2], 123) && i(o[t - 1], 37)) {
            for (i(o[t], 45) && (t = t + 1), Y = t; ue(o[Y]) && (Y = Y + 1, !at(o[Y])); )
              ;
            if (fe = u.slice(Y, Y + q.length), fe.startsWith(V)) {
              t = Y + V.length, Z = Z + 1, Y = -1;
              continue;
            } else if (fe === q)
              if (Z === 0) {
                if (Y = o.indexOf("}", Y + q.length) + 1, Y === -1)
                  return De(113, fe, V);
                break;
              } else
                Z = Z - 1, t = Y + q.length;
          }
        } else if (u.slice(t, t + q.length) === q) {
          R = u.slice(z, t).replace(Xe, c).replace(Ke, c);
          break;
        }
        t = t + 1;
      } while (t < b);
      if (E === 3) {
        ...
        x.types = B = "ignore", x.token = R = u.slice(he, Y), S(x), t = Y - 1, J = [];
      } else
        return r.lineNumber = yt(R, r.lineNumber), R.trim() !== c && (x.token = R, x.lines = r.lineOffset, x.types = "ignore", S(x)), x.types = B = "end", x.token = R = q, t = t + q.length - 1, A();
    }
    function K(q, E) {
      let z = o.lastIndexOf(Qi(s.token[r.count]), r.iterator) + 1;
      if (E === 3 || E === 6) {
        let Y = -1, Z = 0, fe;
        do {
          if ((V === "script" || V === "style") && i(o[t], 47) && (i(o[t + 1], 47) ? t = o.indexOf(H, t + 1) + 1 : i(o[t + 1], 42) && (t = u.indexOf("*/", t + 1) + 2)), i(o[t], 34) || i(o[t], 39) || i(o[t], 96)) {
            if (Y = o.indexOf(o[t], t + 1), Y > -1) {
              r.lineNumber = yt(o.slice(t, Y), r.lineNumber), t = Y + 1, Y = -1;
              continue;
            }
            return De(101, u.slice(t));
          }
          if (E === 3) {
            if (i(o[t - 2], 123) && i(o[t - 1], 37)) {
              if (i(o[t], 45) && (t = t + 1), fe = u.slice(t).trimStart(), fe.startsWith(V)) {
                ...
                continue;
              } else if (fe.startsWith(q))
                if (Z === 0) {
                  if (Y = o.indexOf("}", t + q.length) + 1, Y === -1)
                    return De(113, fe, V);
                  t = Y;
                  break;
                } else
            ...
            Z = Z + 1;
          else if (i(o[t], 60) && i(o[t + 1], 47) && u.slice(t, t + q.length) === q)
            if (Z === 0) {
              t = t + q.length - 1;
              break;
            } else
        ...
        if (Z > 0)
          return E === 3 ? De(114, R, V) : De(105, R, V);
        x.types = "ignore", x.token = R = u.slice(z, t + 1), r.lineNumber = yt(R, r.lineNumber);
      } else
        x.types = "ignore", x.token = R = u.slice(z, t + 1);
      J = [], ae = !1, S(x);
    }
    function y() {
      return B === "script_preserve" || B === "json_preserve" || B === "style_preserve" ? (x.types = "start", x.stack = B === "style_preserve" ? "style" : "script", A(), t = t + 1, J = [], k(`</${V}>`, 2)) : s.types[r.count] === "ignore_next" ? B === "liquid_start" ? K(`end${V}`, 3) : B === "liquid" ? Le.liquid.tags.has(V) ? (B = "liquid_start", K(`end${V}`, 3)) : K(j, j === "}}" ? 1 : 4) : Le.html.voids.has(V) ? K(j, 7) : i(j, 62) ? K(`</${V}>`, 6) : (ae = !1, ie = !1, Q()) : l.has(V) ? k(`end${V}`, 3) : Q();
    }
    function w() {
      if (ae || i(R, 60) && i(R[1], 47))
        return y();
      let q = J.length - 1;
      if (i(R, 60))
        if (q > -1)
          do {
            let E = Ft(V, "html", g(J[q][0], !1));
            if (E !== !1)
        ...
        let E = Ft(V, "liquid", R);
        E !== !1 && (l.has(V) ? (ae = !0, ie = !1) : (B = "liquid_start", h = E.language, F = !0));
      }
      return y();
    }
    function A(q = !1) {
      if (q !== null && S(x), i(o[t], 62) && i(o[t + 1], 47))
        return;
      let E = r.count, z = V.replace(/\/$/, c), Y = n.markup.quoteConvert, Z = 0, fe = 0, he = 0, xe = c, de = c, X = J.length;
      function Se() {
        r.attributes.has(E) && Z + 1 === X && ui(x.token, 62) && (x.token = x.token + ">");
        let We = x.types.indexOf("liquid_attribute") > -1;
        if (ae === !0 || Y === "none" || x.types.indexOf("attribute") < 0 || We === !1 && Y === "single" && x.token.indexOf(Be) < 0 || We === !1 && Y === "double" && x.token.indexOf($e) < 0)
          S(x);
        else {
          let Ae = 0, Ce = !1, re = x.token.split(c), Me = x.token.indexOf("="), Oe = re.length - 1;
          if (M(re[Me + 1], 34) && M(re[re.length - 1], 34) && Y === "single" && We === !1)
            S(x);
          else if (M(re[Me + 1], 39) && M(re[re.length - 1], 39) && Y === "double" && We === !1)
            S(x);
          else {
            if (Ae = Me + 2, We === !1 && (Y === "double" ? (x.token.slice(Me + 2, Oe).indexOf(Be) > -1 && (Ce = !0), re[Me + 1] = Be, re[re.length - 1] = Be) : Y === "single" && (x.token.slice(Me + 2, Oe).indexOf($e) > -1 && (Ce = !0), re[Me + 1] = $e, re[re.length - 1] = $e)), Ce === !0 || We === !0) {
              We = !1;
              do
      ...
      function Ee() {
        ...
        J = ci(J, c, !1), J = We.concat(J), X = J.length;
      }
      function be() {
        S(x, "jsx_attribute", {
          token: `${xe}={`,
          types: "jsx_attribute_start"
        }), r.external("jsx", de.slice(1, de.length - 1)), x.begin = r.count, /\s\}$/.test(de) ? (de = de.slice(0, de.length - 1), de = Pe.exec(de)[0], x.lines = de.indexOf(`
`) < 0 ? 1 : de.split(`
`).length) : x.lines = 0, x.begin = r.stack.index, x.stack = r.stack.token, x.token = "}", x.types = "jsx_attribute_end", Se();
      }
      function Ze() {
        if (xi(J[Z][0]))
          x.types = "liquid_attribute_chain", x.token = J[Z][0];
        else if (Pt(J[Z][0]))
          x.token = J[Z][0], x.types = "liquid_attribute_end", x.ender = x.begin;
        else {
          if (gt(J[Z][0], !0))
            return x.types = "liquid_attribute_start", x.begin = r.count, x.token = J[Z][0], Se(), !0;
          Gt(J[Z][0]) ? (x.types = "liquid_attribute_else", x.token = J[Z][0]) : (x.types = "attribute", x.token = J[Z][0]);
        }
        return Se(), !1;
      }
      if (J.length < 1)
        return q !== !0 ? void 0 : ne();
      if (i(J[J.length - 1][0], 47) && (J.pop(), R = R.replace(/>$/, "/>")), fe = J.length, he = 1, he < fe)
        do
          xe = J[he - 1][0], i(xe[xe.length - 1], 61) && J[he][0].indexOf("=") < 0 && (J[he - 1][0] = xe + J[he][0], J.splice(he, 1), fe = fe - 1, he = he - 1), he = he + 1;
        while (he < fe);
      if ((O > 0 || n.markup.attributeSort === !0) && Ee(), x.begin = E, x.stack = z, x.types = "attribute", Z < X)
        do {
          if (J[Z] === void 0)
            break;
          if (x.lines = J[Z][1], J[Z][0] = J[Z][0].replace(Pe, c), N === !0 && /^\/[/*]/.test(J[Z][0])) {
            x.types = "comment_attribute", x.token = J[Z][0], Se(), Z = Z + 1;
            continue;
          }
          if (J[Z][1] <= 1 && xi(J[Z][0]) && !ln(J[Z][0])) {
            x.types = "liquid_attribute_chain", x.token = J[Z][0], Se(), Z = Z + 1;
            continue;
          }
          if (fe = J[Z][0].indexOf("="), he = J[Z][0].indexOf(Be), fe < 0)
            Pt(J[Z][0]) ? (x.token = J[Z][0], x.types = "liquid_attribute_end", x.ender = x.begin) : gt(J[Z][0], !0) ? (x.types = "liquid_attribute_start", x.begin = r.count, x.token = J[Z][0]) : Gt(J[Z][0]) ? (x.types = "liquid_attribute_else", x.token = J[Z][0]) : on(J[Z][0]) ? (x.types = "liquid_attribute", x.token = J[Z][0]) : i(J[Z][0], 35) || i(J[Z][0], 91) || i(J[Z][0], 123) || i(J[Z][0], 40) || N === !0 ? x.token = J[Z][0] : (x.types = "liquid_attribute", x.token = n.markup.attributeCasing === "preserve" ? J[Z][0] : J[Z][0].toLowerCase()), Se();
          else if (Vt(J[Z][0], 6))
            Ze();
          else {
            xe = J[Z][0].slice(0, fe), n.markup.lineBreakValue === "force-preserve" || n.markup.lineBreakValue === "force-indent" || n.markup.lineBreakValue === "force-align" ? de = J[Z][0][fe + 1] + H + J[Z][0].slice(fe + 2, -1).trim() + H + J[Z][0][J[Z][0].length - 1] : de = J[Z][0].slice(fe + 1), n.markup.attributeCasing === "lowercase-name" ? (xe = xe.toLowerCase(), J[Z][0] = xe + "=" + de) : n.markup.attributeCasing === "lowercase-value" ? (de = de.toLowerCase(), J[Z][0] = xe + "=" + de) : (n.markup.attributeCasing === "lowercase" && (xe = xe.toLowerCase(), de = de.toLowerCase()), J[Z][0] = xe + "=" + de), n.correct === !0 && M(de, 60) && M(de, 123) && M(de, 61) && M(de, 34) && M(de, 39) && (de = Be + de + Be), N === !0 && /^\s*{/.test(de) ? (be(), x.types = "attribute", x.begin = E, x.stack = z) : Vt(xe, 6) ? Ze() : (x.types = "attribute", x.token = J[Z][0], Se());
          }
          Z = Z + 1;
        } while (Z < X);
      if (!q)
    ...
    function v(q) {
      ...
      if (R = E[0], t = E[1], Ei.test(R))
        ...
        if (R.startsWith(ke) && q === !1) {
          let z = R.indexOf("%}", 2) + 2, Y = R.lastIndexOf("{%");
          R = I(R.slice(0, z), V) + R.slice(z, Y) + I(R.slice(Y), V);
        }
        return x.token = R, x.types = "comment", w();
      }
    }
    function $(q) {
      let E = t, z = t + q;
    ...
    function ge() {
      if (j === "---")
        ...
        if (i(o[t + 1], 123) && (i(o[t + 2], 123) || i(o[t + 2], 37))) {
          x.token = $(3), x.types = "liquid_bad_start", S(x);
          return;
        } else if (i(o[t + 1], 47))
          if (i(o[t + 2], 123) && (i(o[t + 3], 123) || i(o[t + 3], 37))) {
            x.token = $(3), x.types = "liquid_bad_end", S(x);
            return;
          } else
            B = "end", j = ">";
        else if (i(o[t + 1], 33))
          if ((i(o[t + 2], 100) || i(o[t + 2], 68)) && (i(o[t + 3], 111) || i(o[t + 3], 79)) && (i(o[t + 4], 99) || i(o[t + 4], 67)) && (i(o[t + 5], 116) || i(o[t + 5], 84)) && (i(o[t + 6], 121) || i(o[t + 6], 89)) && (i(o[t + 7], 112) || i(o[t + 7], 80)) && (i(o[t + 8], 101) || i(o[t + 8], 69)))
            ...
            i(o[t + 8], 91) && (j = "]]>", B = "cdata", ie = !0);
        else
          i(o[t + 1], 63) ? (j = "?>", o[t + 2].charCodeAt(0) === 120 && // x
          o[t + 3].charCodeAt(0) === 109 && // m
          o[t + 4].charCodeAt(0) === 109 ? (B = "xml", ce = !0) : (ie = !0, B = "liquid")) : i(o[t + 1], 112) && //   p
          i(o[t + 2], 114) && //   r
          i(o[t + 3], 101) && // e
          (i(o[t + 4], 62) || ue(o[t + 4])) ? (j = "</pre>", B = "ignore", ie = !0) : (ce = !0, j = ">");
      else if (i(o[t], 123)) {
        if (N) {
          F = !0, we = !0, r.stack.push(["script", r.count]), S(x, { token: "{", types: "script_start" });
          return;
        }
        if (i(o[t + 1], 123))
          ie = !0, j = "}}", B = "liquid";
          ...
          ie = !0, j = "%}", B = "liquid", G = "}";
          let q = u.indexOf(j, t + 3);
          if (q === -1)
            return De(113, u.slice(t));
          if (i(o[t + 2], 45) ? (ke = "{%-", V = ri.exec(u.slice(t + 3, q).trimStart())[0]) : (ke = "{%", V = ri.exec(u.slice(t + 2, q).trimStart())[0]), V === "comment") {
            B = "comment";
            let E = u.indexOf("endcomment", q + 2);
            return E === -1 ? De(114, u.slice(t, q + 2), "comment") : (ke = u.slice(t, q + 2), j = u.slice(u.lastIndexOf("{", E), u.indexOf("}", E + 10) + 1), v());
          } else if (l.size > 0 && l.has(V) && (r.iterator = t, ae = !0), i(V, 35))
            return B = "comment", v(!0);
        } else
          ie = !0, j = o[t + 1] + "}", B = "liquid";
      }
      return ie !== !0 && n.markup.preserveAttribute === !0 && (ie = !0), r.count > -1 && s.types[r.count] === "ignore_next" && (ae = !0, r.iterator = t), G || (G = j.charAt(j.length - 1)), we ? w() : B === "comment" ? v() : t < b ? pe() : w();
    }
    function ne() {
      if (n.wrap > 0 && N === !0) {
        let q = 0, E = r.count, z = 0;
        if (s.types[E].indexOf("attribute") > -1) {
          do
            q = q + s.token[E].length + 1, E = E - 1;
          while (s.lexer[E] !== "markup" || s.types[E].indexOf("attribute") > -1);
          s.lines[E] === 1 && (q = q + s.token[E].length + 1);
        } else
          s.lines[E] === 1 && (q = s.token[E].length + 1);
        if (z = E - 1, q > 0 && s.types[z] !== "script_end")
          if (s.types[z].indexOf("attribute") > -1) {
            do
              q = q + s.token[z].length + 1, z = z - 1;
            while (s.lexer[z] !== "markup" || s.types[z].indexOf("attribute") > -1);
            s.lines[z] === 1 && (q = q + s.token[z].length + 1);
          } else
            s.lines[z] === 1 && (q = s.token[z].length + 1);
      }
      r.lineOffset = 0;
    }
    function pe() {
      ...
      function Me() {
        if (Qe(q, 44)) {
          if (V === "when" && E.logic.push(q.length - 1), n.correct === !0 && /^,\s*-?[%}]}/.test(u.slice(t)))
            return q.pop(), t = t + 1, !0;
          Ce === 44 ? E.fargs[E.fargs.length - 1].push(q.length - 1) : Ce === 58 ? (E.fargs[E.fargs.length - 1][0] += 1, E.fargs[E.fargs.length - 1].push(q.length - 1), Ce = 44) : E.targs.push(q.length - 1);
        } else
          Qe(q, 124) ? (E.pipes.push(q.length - 1), Ce = 124) : Qe(q, 58) && Ce === 124 && (E.fargs.push([q.length - 1]), Ce = 58);
        if (i(o[t], 10) && V !== "liquid" && Ze === !1 && q.length > 3 && !(i(o[t + 1], 45) && i(o[t + 2], 37) && i(o[t + 3], 125) || i(o[t + 1], 37) && i(o[t + 2], 125)) ? q.pop() : n.liquid.normalizeSpacing === !0 && (Te(o[t]) === !1 && (mt(q, 39) || mt(q, 34)) ? M(o[t], 44) && M(o[t], 93) ? (q.splice(q.length - 1, 1, te, o[t]), Te(o[t + 1]) === !1 && M(o[t + 1], 61) && M(o[t + 1], 125) && q.push(te)) : at(o[t + 1]) && M(o[t + 1], 91) && M(o[t + 1], 46) && q.push(te) : V !== "liquid" && ue(o[t + 1]) && ue(o[t]) && i(o[t - 1], 93) || i(o[t], 32) && i(o[t + 1], 32) ? q.pop() : q.length > 3 && i(o[t + 1], 10) && M(o[t + 2], 32) ? q.push(te) : i(o[t], 32) && i(o[t + 1], 32) ? q.pop() : mt(q, 93) && Te(q[q.length - 1]) && M(o[t], 32) && M(o[t], 44) && M(o[t], 46) ? q.splice(q.length - 1, 1, te, o[t]) : Te(q[q.length - 2]) && Te(o[t]) && Te(o[t + 1]) ? q.pop() : i(o[t], 44) && at(o[t + 1]) ? q.push(te) : i(o[t], 58) && at(o[t + 1]) ? q.push(te) : i(o[t], 32) && mt(q, 46) || Fi(q, 91, 32) ? q.pop() : M(o[t], 32) && i(o[t + 1], 124) ? q.push(te) : i(o[t], 124) && M(o[t + 1], 32) ? q.push(te) : i(o[t], 32) && (i(o[t + 1], 46) || i(o[t + 1], 93) || i(o[t + 1], 91) || i(o[t + 1], 58) || i(o[t + 1], 44)) ? q.pop() : V === "assign" && (M(o[t], 32) && i(o[t + 1], 61) || i(o[t], 61) && M(o[t + 1], 32)) ? q.push(te) : (V === "if" || V === "unless" || V === "elsif" || V === "liquid") && ((M(o[t], 32) || i(o[t], 10)) && (i(o[t + 1], 33) || i(o[t + 1], 60) || i(o[t + 1], 62) || i(o[t + 1], 61) && i(o[t + 2], 61)) ? q.push(te) : i(o[t], 61) && (M(o[t + 1], 32) || i(o[t + 1], 10)) && (i(o[t - 1], 61) || i(o[t - 1], 60) || i(o[t - 1], 62) || i(o[t - 1], 33)) ? q.push(te) : M(o[t + 1], 32) && M(o[t + 1], 61) && (i(o[t], 60) || i(o[t], 62)) && q.push(te))), ue(o[t - 1])) {
          if (Z = u.slice(t), V === "if" || V === "elsif" || V === "unless") {
            if (ue(o[t + 2]) && Z.startsWith("or"))
              return E.logic.push(q.length - 1), q.pop(), q.push(Z.slice(0, 2)), t = t + 2, !0;
            if (ue(o[t + 3]) && Z.startsWith("and"))
              return E.logic.push(q.length - 1), q.pop(), q.push(Z.slice(0, 3)), t = t + 3, !0;
            if (ue(o[t + 8]) && Z.startsWith("contains"))
              return E.logic.push(q.length - 1), q.pop(), q.push(Z.slice(0, 8)), t = t + 8, !0;
          } else if (V === "when" && ue(o[t + 2]) && Z.startsWith("or"))
            return E.logic.push(q.length - 1), q.pop(), q.push(Z.slice(0, 2)), t = t + 2, !0;
        }
        if (i(q[q.length - 1], 44) && i(q[q.length - 2], 44))
          return De(
            116,
            q.join(c),
            Ue(q.join(c))
      ...
      function Oe(Lt) {
        let et, ve = c;
        if (Lt === !0 ? (ve = re.join(c), et = g(ve), X = c, et[0] === "data-esthetic-ignore" && (ae = !0)) : (ve = re.join(c), (N === !1 || N && ui(ve, 125)) && (ve = ve.replace(Ye, te)), et = g(ve), et[0] === "data-esthetic-ignore" && (ae = !0), N && i(re[0], 123) && i(re[re.length - 1], 125) && (Ee = 0)), i(ve[0], 123) && i(ve[1], 37) && (me = !0), ve = ve.replace(/^\u0020/, c).replace(/\u0020$/, c), re = ve.replace(/\r\n/g, H).split(H), re.length < 1 && (re[0] = re[0].replace(Pe, c)), ve = I(re.join(r.crlf), V), n.markup.stripAttributeLines === !0 && de >= 1 && (de = 1), J.length > 0) {
          let Je = J.length - 1;
          m === 0 && (i(ve, 61) || i(ve, 45)) && (J[Je][0] = J[Je][0] + ve, J[Je][1] = de, ve = c);
        }
        if (Lt === !1 && (gt(ve) && (m = m + 1), Pt(ve) && (m = m - 1)), ve !== c && ve !== te && J.push([ve, de]), J.length > 0) {
          let [Je] = J[J.length - 1];
          if (Je.indexOf("=\u201C") > 0)
            return De(103, Je);
          if (Je.indexOf("=\u201D") > 0)
      ...
      if (!r.error) {
        do {
          if (i(o[t], 10) && (de = r.lines(t, de)), ke === "---" && j === "---" && B === "ignore") {
            if (q.push(o[t]), t > 3 && i(o[t], 45) && i(o[t - 1], 45) && i(o[t - 2], 45))
              break;
            t = t + 1;
            continue;
          }
          if (ie === !0 || ue(o[t]) === !1 && M(X, 125) || i(X, 125)) {
            if (q.push(o[t]), be === !1 && i(o[t - 1], 123) && (i(o[t], 123) || i(o[t], 37)))
              be = !0;
            else if (be === !0 && i(o[t], 125)) {
              if (i(o[t - 1], 125) || i(o[t - 1], 37))
                be = !1;
              else if ((i(o[t - 2], 125) || i(o[t - 2], 37)) && ue(o[t - 1]))
                return De(113, q.join(c));
            ...
            if (B === "end" && q.length > 2 && i(q[0], 60) && i(q[1], 47) && (i(q[q.length - 1], 47) || i(q[q.length - 1], 60))) {
              if (n.correct)
                q.pop(), q.push(">");
              else
                return De(106, q.join(c));
              break;
            }
            if (i(q[0], 60) && i(q[1], 62) && i(j, 62))
              return S(x, "(empty)", {
                token: "<>",
                types: "start"
              });
            if (i(q[0], 60) && i(q[1], 47) && i(q[2], 62) && i(j, 62))
              return x.token = "</>", x.token = "end", S(x);
          }
          if (B === "cdata" && i(o[t], 62) && i(o[t - 1], 93) && M(o[t - 2], 93))
            return De(103, q.join(c));
          if (B === "comment") {
            if (X = c, o[t] === G && q.length > j.length + 1) {
              if (Y = q.length, z = j.length - 1, z > -1)
                do {
                  if (Y = Y - 1, M(q[Y], j.charCodeAt(z)))
                    break;
                  z = z - 1;
                } while (z > -1);
              if (z < 0)
            ...
            if (N && (i(o[t], 123) ? Ee = Ee + 1 : i(o[t], 125) && (Ee = Ee - 1)), i(o[t], 60) && ce === !0 && ie === !1 && q.length > 1 && />{2,3}/.test(j) === !1) {
              r.error = `Invalid structure detected ${o.slice(t, t + 8).join(c)}`;
              break;
            }
            if (ue(o[t]) === !1 && st === !0 && o[t] !== G) {
              if (L = 0, st = !1, X = Se, q.pop(), t < b)
                do {
                  if (i(o[t], 10) && Ae === !1 && (de = r.lines(t, de)), n.markup.preserveAttribute === !0 ? q.push(o[t]) : re.push(o[t]), (M(X, 34) || M(X, 39)) && (i(o[t - 1], 123) && (i(o[t], 37) || i(o[t], 123)) ? be = !0 : i(o[t], 125) && (i(o[t - 1], 125) || i(o[t - 1], 37)) && (be = !1)), N === !1 && Ae === !1 && be === !0 && n.markup.preserveAttribute === !1)
                    for (; t < b; ) {
                  ...
                  if (N === !1 && (i(o[t], 60) || i(o[t], 62)) && (X === c || i(X, 62))) {
                    ...
                    if (o[t + 1] === G) {
                      (Qe(re, 47) || Qe(re, 63) && B === "xml") && (re.pop(), ie === !1 || q.pop(), t = t - 1), re.length > 0 && Oe(!1);
                      break;
                    }
                    if (N === !1 && i(o[t], 123) && i(o[t - 1], 61) ? X = "}" : i(o[t], 34) || i(o[t], 39) ? (X = o[t], Ae === !1 && be === !1 && (Ae = !0), i(o[t - 1], 61) && (i(o[t + 1], 60) || i(o[t + 1], 123) && i(o[t + 2], 37) || ue(o[t + 1]) && M(o[t - 1], 61)) && (L = t)) : i(o[t], 40) ? (X = ")", xe = 1) : N ? (i(o[t - 1], 61) || ue(o[t - 1])) && i(o[t], 123) ? (X = "}", he = 1) : i(o[t], 47) && (i(o[t + 1], 42) ? X = "*/" : i(o[t + 1], 47) && (X = H)) : i(q[0], 123) && i(o[t], 123) && (i(o[t + 1], 123) || i(o[t + 1], 37)) && (X = i(o[t + 1], 123) ? "}}" : o[t + 1] + "}"), ue(o[t]) && X === c) {
                    ...
                    if (i(X, 125)) {
                      if (i(o[t], 125) && o[t] !== X)
                        ...
                        Ee = 0, X = c, R = re.join(c), n.markup.preserveAttribute === !1 && (N ? /^\s*$/.test(R) || J.push([R, de]) : (R = R.replace(Ye, te), R !== te && J.push([R, de]))), re = [], de = 1;
                        break;
                      }
                    } else {
                      Se = c, ye = !0, R = re.join(c), R !== te && J.push([R, de]), re = [], de = i(X, 10) ? 2 : 1, X = c;
                      break;
                    }
              ...
              X = "-->";
            else if (i(o[t], 123) && M(q[0], 123) && M(j, 10) && (i(o[t + 1], 123) || i(o[t + 1], 37))) {
              if (i(o[t + 1], 123))
                X = "}}";
              ...
              st = !0, q[q.length - 1] = te, Se = i(o[t + 1], 42) ? "*/" : H, re.push(o[t]);
            else if (be === !1 && (o[t] === G || i(j, 10) && i(o[t + 1], 60)) && (q.length > j.length + 1 || i(q[0], 93)) && (N === !1 || Ee === 0)) {
              if (i(j, 10)) {
                if (ue(q[q.length - 1]))
                  do
                    q.pop(), t = t - 1;
                  while (ue(q[q.length - 1]));
                break;
              }
              if (Y = q.length, z = j.length - 1, z > -1)
                do {
                  if (Y = Y - 1, q[Y] !== j.charAt(z))
                    break;
                  z = z - 1;
                } while (z > -1);
              if (z < 0) {
                i(q[Y], 62) && i(o[t], 62) && i(o[t - 1], 125) && ue(o[t + 1]) && J.length > 0 && J[J.length - 1][1] === 0 && (J[J.length - 1][1] = i(o[t + 1], 32) ? 1 : 2);
                break;
              }
            }
          } else if (i(o[t], X.charCodeAt(X.length - 1)) && M(o[t - 1], 92) && (N === !0 && i(j, 125) && D(t) === !1 || N === !1 || M(j, 125))) {
            if (Y = 0, z = X.length - 1, z > -1)
              do {
                if (M(o[t - Y], X.charCodeAt(z)))
                  break;
  ...
  function C() {
    ...
    if (t < b) {
        ...
        if (i(o[t], 10) && (V = r.lines(t, V)), F === !0) {
          if (ke === 3) {
            ...
            if (oe > -1) {
              ...
              if (ie = u.slice(se, ee), rn(T).test(ie)) {
                V = 1, J = u.slice(t, se), r.external(h, J), V !== r.lineOffset && (V = r.lineOffset), ae.token = I(ie), ae.types = "liquid_end", ae.lines = V, S(ae), t = ee - 1, F = !1;
                break;
              }
            }
          }
          if (ce === c) {
            if (i(o[t], 47))
              ...
              ce = o[t];
            else if (i(o[t], 123) && R === !0)
              P = P + 1;
            else if (i(o[t], 125) && R === !0) {
              if (P === 0) {
            ...
            if (we === "script" && i(o[t], 60) && i(o[t + 1], 47)) {
              if (ie = u.slice(t, t + 9).toLowerCase(), ie === "</script>") {
                if (j.length < 1)
                  break;
                J = j.join(c).trimEnd(), vt.test(J) && Rt.test(J) ? (S(ae, { token: "<!--", types: "comment" }), J = J.replace(vt, c).replace(Rt, c), r.external("javascript", J), S(ae, { token: "-->" })) : (r.external(h, J), ae.token = ie, ae.types = "end", t = t - 1);
                break;
              }
            } else if (we === "style" && i(o[t], 60) && i(o[t + 1], 47) && (ie = u.slice(t, t + 8).toLowerCase(), ie === "</style>")) {
              if (j.length < 1)
                break;
              J = j.join(c).trimEnd(), vt.test(J) && Rt.test(J) ? (S(ae, { token: "<!--", types: "comment" }), J = J.replace(vt, c).replace(Rt, c), r.external("css", J), S(ae, { token: "-->" })) : (r.external(h, J), ae.token = ie, ae.types = "end", t = t - 1);
              break;
            }
          } else
            ce === o[t] && ye() === !1 && (i(ce, 34) || i(ce, 39) || i(ce, 96) || i(ce, 42) && i(o[t + 1], 47)) ? ce = c : i(ce, 96) && i(o[t], 36) && i(o[t + 1], 123) && ye() === !1 ? ce = "}" : i(ce, 125) && i(o[t], 125) && ye() === !1 ? ce = "`" : i(ce, 47) && (i(o[t], 10) || i(o[t], 13)) ? ce = c : ce === "r" && i(o[t], 47) && ye() === !1 ? ce = c : i(ce, 47) && i(o[t], 62) && i(o[t - 1], 45) && i(o[t - 2], 45) && (ie = u.slice(t + 1, t + 11).toLowerCase(), ie = ie.slice(0, ie.length - 2), we === "script" && ie === "</" && (ce = c), ie = ie.slice(0, ie.length - 1), we === "style" && ie === "</style" && (ce = c));
        }
        if (L() === !0 && i(o[t], 93)) {
          t = t - 1, V = 0, B = j.join(c).replace(Pe, c), S(ae, { token: B });
          break;
        }
        if (F === !1 && j.length > 0 && (i(o[t], 60) && M(o[t + 1], 61) && He(o[t + 1]) === !1 && at(o[t + 1]) || i(o[t], 123) && i(o[t + 1], 37) || i(o[t], 123) && (N === !0 || i(o[t + 1], 123) || i(o[t + 1], 37)) || Ni.test(o[t]) === !1 && Ge(o[t + 1]) || i(o[t], 46) && Ge(o[t + 1]) && t + 1 === b)) {
          if (t = t - 1, V = 0, B = r.stack.token === "comment" ? j.join(c) : j.join(c).replace(Pe, c), ae.token = B, n.wrap > 0 && n.markup.preserveText === !1) {
            ...
            B = j.join(c).replace(pt, c).replace(Pe, c).replace(Ye, te);
            do
              ee();
            while (T < oe);
            B !== c && M(B, 32) && se.push(B), B = se.join(r.crlf), B = c + B + c;
          } else if (n.markup.preserveText === !0)
            B = a(x, B);
          else {
            let T = B.indexOf(H);
            if (T > -1) {
              ...
              do
                if (S(ae, {
                  token: B.slice(oe, T).trim().replace(kt, te)
                }), oe = T + 1, T = B.indexOf(H, oe), ae.lines = 2, T < 0)
                  break;
              while (T < B.length);
              S(ae, {
                token: B.slice(oe).trim().replace(kt, te)
              }), ae.lines = 2;
              break;
            } else
              B = B.trim().replace(kt, te);
          }
          V = 0, ae.token = B, S(ae);
          break;
        }
      ...
      ae.types === "content" && n.markup.preserveText === !0 && j.unshift(a(x));
    }
    if (t > x && t < b)
      if (ue(o[t])) {
        let ie = t;
        ...
        do
          i(o[ie], 10) && (r.lineNumber = r.lineNumber + 1, r.lineOffset = r.lineOffset + 1), ie = ie - 1;
        while (ie > x && ue(o[ie]));
      } else
        r.lineOffset = 0;
    else
      (t !== x || t === x && F === !1) && (ke === 3 && ae.types === "liquid_end" ? B = I(j.join(c).replace(Pe, c)) : B = j.join(c).replace(Pe, c), V = 0, ae.token !== B && (ke === 3 && ae.types === "liquid_end" && (B = I(B)), ae.token = B, S(ae), r.lineOffset = 0));
    F = !1;
  }
  function U() {
    r.lineOffset = 1;
...
function fn() {
  let { data: e, references: s, rules: n, source: u } = r, N = r.language === "json" ? n.json : n.script, l = Ne(u) ? u : u.split(c), O = l.length, o = [], b = [], f = [], t = [0, c], h = [!1], F = { count: [], index: [], word: [] }, le = -1, m = 0, p = c, S = c, I = [], D = 0, d = -1, a = -1, g = [], W, C, U, j = [
    "autoescape",
    "block",
    "capture",
    "case",
  ...
  function G(y, w) {
    let A = w === !0 ? m : m + 1, v = c;
    if ((typeof y != "number" || y < 1) && (y = 1), i(l[m], 47) && (i(l[m + 1], 47) ? v = H : i(l[m + 1], 42) && (v = "/")), A < O)
      do {
        if (ue(l[A]) === !1) {
          if (i(l[A], 47) && (v === c ? i(l[A + 1], 47) ? v = H : i(l[A + 1], 42) && (v = "/") : i(v, 47) && i(l[A - 1], 42) && (v = c)), v === c && l[A - 1] + l[A] !== "*/")
            return l.slice(A, A + y).join(c);
        } else
          i(v, 10) && i(l[A], 10) && (v = c);
        A = A + 1;
      } while (A < O);
  ...
  function V(y) {
    ...
    if (!(v.types === "comment" || A === "method" || A === "paren" || A === "expression" || A === "array" || A === "object" || A === "switch" && v.stack !== "method" && i(e.token[e.begin[r.count]], 40) && e.token[e.begin[r.count] - 1] !== "return" && e.types[e.begin[r.count] - 1] !== "operator") && !(e.stack[r.count] === "expression" && (e.token[e.begin[r.count] - 1] !== "while" || e.token[e.begin[r.count] - 1] === "while" && e.stack[e.begin[r.count] - 2] !== "do")) && !(w !== c && "=<>+*?|^:&%~,.()]".indexOf(w) > -1 && y === !1)) {
      ...
      v.token === void 0 || v.types === "start" || v.types === "separator" || v.types === "operator" && v.token !== "++" && v.token !== "--" || v.token === "x}" || v.token === "var" || v.token === "let" || v.token === "const" || v.token === "else" || v.token.indexOf("#!/") === 0 || v.token === "instanceof" || v.stack === "method" && (e.token[v.begin - 1] === "function" || e.token[v.begin - 2] === "function") || (N.variableList === "list" && (F.index[le] = r.count), p = n.correct === !0 ? ";" : "x;", S = "separator", $ = r.lineOffset, r.lineOffset = 0, R(), r.lineOffset = $, oe());
    }
  }
  function ke() {
    let y = r.count;
  ...
  function ae() {
    V(!1), d > -1 && k(), U = wt(l, {
      ...
      start: m,
      ender: "*/"
    }), m = U[1], e.token[r.count] === "var" || e.token[r.count] === "let" || e.token[r.count] === "const" ? (W = r.pop(e), R(), r.push(e, W, c), e.lines[r.count - 2] === 0 && (e.lines[r.count - 2] = e.lines[r.count]), e.lines[r.count] = 0) : U[0] !== c && (p = U[0], S = Mt.test(p) ? "ignore" : "comment", p.indexOf("# sourceMappingURL=") === 2 && (t[0] = r.count + 1, t[1] = p), r.push(e, {
      begin: r.stack.index,
      ender: -1,
      lexer: "script",
      lines: r.lineOffset,
    ...
    if (w = m + 1, w < O)
      do {
        if (He(l[w]) || i(l[w], 46) && A === !1)
          y.push(l[w]), i(l[w], 46) && (A = !0);
        else
          break;
        w = w + 1;
      } while (w < O);
    if (w < O - 1 && (He(l[w - 1]) || He(l[w - 2]) && (i(l[w - 1], 45) || i(l[w - 1], 43))) && (l[w] === "e" || l[w] === "E") && (y.push(l[w]), (i(l[w + 1], 45) || i(l[w + 1], 43)) && (y.push(l[w + 1]), w = w + 1), A = !1, w = w + 1, w < O))
      do {
        if (He(l[w]) || i(l[w], 46) && A === !1)
          y.push(l[w]), i(l[w], 46) && (A = !0);
        else
  ...
  function ie() {
    ...
    if (d > -1 && k(), i(l[m], 47) && r.count > -1 && (S !== "word" && S !== "reference" || p === "typeof" || p === "return" || p === "else") && S !== "number" && S !== "string" && S !== "end")
      return p === "return" || p === "typeof" || p === "else" || S !== "word" ? (p = ye(), S = "regex") : (p = "/", S = "operator"), R(), "regex";
        ...
        if (e.stack[r.count] === "arguments")
          ...
          do {
            if (e.begin[y] === e.begin[r.count]) {
              if (y < r.count && e.token[y] === ":" && e.types[y + 1] !== "type" && (ne = !0), e.token[y] === "?" && ne === !1 || e.token[y] === ";" || e.token[y] === "x;")
                break;
    ...
    if (v === c)
      if (i(l[m + 1], 43) && i(l[m + 2], 43) || i(l[m + 1], 45) && i(l[m + 2], 45))
        ...
        if (y = m + 1, y < A)
          do {
            if (i(l[y], 43) && i(l[y + 1], 43) || i(l[y], 45) && i(l[y + 1], 45))
              break;
            if (w = 0, w < ge)
              do {
                if (l[y] === $[w]) {
    ...
    if (m = m + (v.length - 1), v === "=>" && i(p, 41)) {
      y = r.count, A = e.begin[y];
      do
        e.begin[y] === A && (e.stack[y] = "method"), y = y - 1;
      while (y > A - 1);
    }
    return v;
  }
  function ce() {
    ...
    if (m = m + 1, m < O)
      do {
        if (y.push(l[m]), i(l[m], 96) && (M(l[m - 1], 92) || !B(m - 1)) || i(l[m - 1], 36) && i(l[m], 123) && (M(l[m - 2], 92) || !B(m - 2)))
          break;
        m = m + 1;
      } while (m < O);
    return y.join(c);
  ...
  function J() {
    let y = 0, w = !1, A = !1, v = 0, $ = 0, ge = 0, ne = c, pe = c, q = c, E = [], z = h[h.length - 1], Y = "0123456789=<>+-*?|^:&.,;%(){}[]~";
    function Z() {
      i(p, 40) && r.stack.update("paren", r.count), r.external("html", E.join(c));
    }
    if (d > -1 && k(), pe = r.count > 0 ? e.token[r.count - 1] : c, q = r.count > 0 ? e.types[r.count - 1] : c, ne = G(1, !1), r.language !== "jsx" && r.language !== "tsx" && He(ne) === !1 && (p === "function" || pe === "=>" || pe === "void" || pe === "." || p === "return" || S === "operator" || e.stack[r.count] === "arguments" || S === "type" && pe === "type" || S === "reference" && (q === "operator" || pe === "function" || pe === "class" || pe === "new") || S === "type" && q === "operator")) {
      let fe = [], he = 0, xe = 0;
      y = m;
      do {
        if (fe.push(l[y]), i(l[y], 60))
          he = he + 1;
        else if (i(l[y], 62) && (he = he - 1, he < 1))
          break;
        y = y + 1;
      } while (y < O);
      if (xe = m, m = y, ne = G(1, !1), i(l[y], 62) && (z === !0 || pe === "=>" || pe === "." || q !== "operator" || q === "operator" && (i(ne, 40) || i(ne, 61)))) {
        S = "generic", p = fe.join(c).replace(/^<\s+/, "<").replace(/\s+>$/, ">").replace(/,\s*/g, ", "), R();
        return;
      }
      m = xe;
    }
    if (y = r.count, e.types[y] === "comment")
      do
        y = y - 1;
      while (y > 0 && e.types[y] === "comment");
    if (z === !1 && G(1, !1) !== ">" && (M(l[m], 60) && Y.indexOf(l[m + 1]) > -1 || e.token[y] === "++" || e.token[y] === "--" || ue(l[m + 1]) === !0 || He(l[m + 1]) === !0 && (S === "operator" || S === "string" || S === "number" || S === "reference" || S === "word" && p !== "return")))
      return S = "operator", p = ie(), R();
        ...
        if (E.push(l[m]), i(l[m], 123))
          ...
          if (v = v - 1, A === !0 ? ge = ge - 1 : M(l[m - 1], 47) && (ge = ge + 1), v === 0 && $ === 0 && ge < 1) {
            ...
            if (i(ne, 60) && Y.indexOf(ne.charAt(1)) < 0 && ue(ne.charAt(1)) === !1) {
              y = m + 1;
              do {
                if (y = y + 1, i(l[y], 62) || ue(l[y - 1]) && Y.indexOf(l[y]) < 0)
                  break;
                if (Y.indexOf(l[y]) > -1)
                  return Z();
              } while (y < O);
  ...
  function P() {
    let y = !0, w = "+", A = c, v = c, $ = c, ge = c, ne = 0, pe = 0, q = 0, E = [];
    function z() {
    ...
    if (A = e.token[r.count], v = e.token[r.count - 1], $ = e.token[r.count - 2], A !== "++" && A !== "--" && v !== "++" && v !== "--" && (pe = r.count, e.types[pe] === "end" ? z() : i(e.token[pe - 1], 46) && Y()), e.token[pe - 1] === "++" || e.token[pe - 1] === "--") {
      ...
      if (ge = G(1, !1), (A === "++" || A === "--") && (i(l[m], 59) || i(ge, 59) || i(l[m], 125) || i(ge, 125) || i(l[m], 41) || i(ge, 41))) {
        ...
        if (i(e.token[q], 44) && M(l[m], 59) && M(ge, 59) && M(l[m], 125) && M(ge, 125) && M(l[m], 41) && M(ge, 41))
          return;
          ...
          if (e.stack[q] === "switch" && i(e.token[q], 58))
            do {
              if (q = q - 1, e.types[q] === "start") {
                ...
                e.types[q] === "end" && (ne = ne + 1);
              if (i(e.token[q], 63) && ne === 0)
                return;
            } while (q > 0);
          else
            return;
        ...
        return;
      if (y === !1 && (W = r.pop(e)), pe = r.count, e.types[pe] === "end" ? z() : i(e.token[pe - 1], 46) && Y(), q = pe, q < r.count + 1)
        do
          E.push(fe(q)), q = q + 1;
        while (q < r.count + 1);
    }
    y === !0 ? (r.splice({
      ...
      howmany: 1,
      index: pe - 1
    }), p = "=", S = "operator", R(), Z(), p = w, S = "operator", R(), p = "1", S = "number", R()) : (p = "=", S = "operator", R(), Z(), p = w, S = "operator", R(), p = "1", S = "number", R()), p = e.token[r.count], S = e.types[r.count], i(ge, 125) && M(l[m], 59) && V(!1);
  }
  function T(y, w, A) {
    let v = 0, $ = !1, ge = !1, ne = [y], pe, q = w.split(c), E = q.length, z = m, Y = m + y.length, Z = N.quoteConvert;
    function fe() {
      let xe = 0;
    ...
    function he() {
      ...
      if (i(y, 34) && Z === "single" ? (ne[0] = $e, ne[ne.length - 1] = $e) : i(y, 39) && Z === "double" ? (ne[0] = Be, ne[ne.length - 1] = Be) : $ === !0 && (xe = ne[ne.length - 1], ne.pop(), ne.pop(), ne.push(xe)), m = v, w === H && (m = m - 1, ne.pop()), p = ne.join(c), (i(y, 34) || i(y, 39) || y === "{{" || y === "{%") && (p = de(p)), y === "{%" || y === "{{") {
        pe = Q(p), S = pe[0], R(pe[1]);
        return;
      }
      if (A === "string") {
    ...
    if (d > -1 && k(), i(l[m - 1], 92) && B(m - 1) === !0 && (i(l[m], 34) || i(l[m], 39)))
      if (r.pop(e), i(e.token[0], 123))
        i(l[m], 34) ? (y = Be, w = '\\"', ne = [Be]) : (y = $e, w = "\\'", ne = [$e]), $ = !0;
      else {
        if (i(l[m], 34)) {
          ne = ['\\"'], he();
          return;
    ...
    if (v = Y, v < O)
      do {
        if (M(e.token[0], 123) && M(e.token[0], 91) && Z !== "none" && (i(l[v], 34) || i(l[v], 39)) ? (i(l[v - 1], 92) ? B(v - 1) === !0 && (Z === "double" && i(l[v], 39) || Z === "single" && i(l[v], 34)) && ne.pop() : Z === "double" && i(l[v], 34) && i(l[m], 39) ? l[v] = Be : Z === "single" && i(l[v], 39) && i(l[m], 34) && (l[v] = $e), ne.push(l[v])) : v > z ? (ge = !0, i(l[v], 123) && i(l[v + 1], 37) && l[v + 2] !== y ? (he(), T("{%", "%}", "liquid"), fe()) : i(l[v], 123) && i(l[v + 1], 123) && l[v + 2] !== y ? (he(), T("{{", "}}", "liquid"), fe()) : (ge = !1, ne.push(l[v]))) : ne.push(l[v]), r.language !== "json" && r.language !== "javascript" && (i(y, 34) || i(y, 39)) && (ge === !0 || v > z) && M(l[v - 1], 92) && M(l[v], 34) && M(l[v], 39) && (i(l[v], 10) || v === O - 1)) {
          r.error = "Unterminated string in script on line number " + r.lineNumber;
          break;
        }
        if (l[v] === q[E - 1] && (M(l[v - 1], 92) || B(v - 1) === !1) && (E === 1 || ne[v - Y] === q[0] && ne.slice(v - Y - E + 2).join(c) === w))
          break;
        v = v + 1;
      } while (v < O);
    he();
  ...
  function oe() {
    let y = c, w = G(5, !1), A = r.count, v = r.lineOffset;
    if (!(r.language === "json" || b.length < 1 || b[b.length - 1].charAt(0) !== "x" || /^x?(;|\}|\))$/.test(p) === !1) && !(e.stack[r.count] === "do" && w === "while" && i(e.token[r.count], 125))) {
      if (i(p, 59) && e.token[A - 1] === "x{") {
        if (y = e.token[e.begin[A - 2] - 1], e.token[A - 2] === "do" || i(e.token[A - 2], 41) && "ifforwhilecatch".indexOf(y) > -1) {
          W = r.pop(e), p = n.correct === !0 ? "}" : "x}", S = "end", C = r.stack.entry, R(), b.pop(), r.lineOffset = v;
          return;
        }
        W = r.pop(e), p = n.correct === !0 ? "}" : "x}", S = "end", C = r.stack.entry, R(), b.pop(), p = ";", S = "end", r.push(e, W, c), r.lineOffset = v;
        return;
      }
      if (p = n.correct === !0 ? "}" : "x}", S = "end", e.token[r.count] !== "x}") {
        if (w === "else" && e.stack[r.count] === "if" && (i(e.token[r.count], 59) || e.token[r.count] === "x;")) {
          C = r.stack.entry, R(), b.pop(), r.lineOffset = v;
          return;
        }
        do
          if (C = r.stack.entry, R(), b.pop(), e.stack[r.count] === "do")
            break;
  ...
  function se() {
    let y = r.count;
    if (e.stack[y] === "object" && N.objectSort === !0)
      p = ",", S = "separator", ke(), R();
    else {
      do
        y = y - 1;
  ...
  function ee(y) {
    ...
    function ge() {
      let ne = 0, pe = e.token[$ - 1] === "Array", q = pe ? "[" : "{", E = pe ? "]" : "}", z = pe ? "array" : "object";
      if (pe === !0 && e.types[r.count] === "number" && (ne = Number(e.token[r.count]), W = r.pop(e)), W = r.pop(e), W = r.pop(e), W = r.pop(e), r.stack.pop(), p = q, S = "start", R(z), ne > 0) {
        p = ",", S = "separator";
        do
          R(), ne = ne - 1;
        while (ne > 0);
    ...
    if (d > -1 && k(), f.length > 0 && (f[f.length - 1] === 0 ? f.pop() : f[f.length - 1] = f[f.length - 1] - 1), (i(y, 41) || y === "x)" || i(y, 93)) && (n.correct === !0 && P(), ke()), (i(y, 41) || y === "x)") && V(!1), le > -1 && (i(y, 125) && (N.variableList === "list" && F.count[le] === 0 || e.token[r.count] === "x;" && N.variableList === "each") && x(), F.count[le] = F.count[le] - 1, F.count[le] < 0 && x()), i(p, 44) && e.stack[r.count] !== "initializer" && (i(y, 93) && i(e.token[r.count - 1], 91) || i(y, 125)) && (W = r.pop(e)), i(y, 41) || y === "x)" ? (p = y, o.length > 0 && (I = o[o.length - 1], I.length > 1 && M(v, 123) && (I[0] === "if" || I[0] === "for" || I[0] === "with" || I[0] === "while" && e.stack[I[1] - 2] !== void 0 && e.stack[I[1] - 2] !== "do") && (w = !0))) : i(y, 93) ? p = "]" : i(y, 125) && (M(p, 44) && n.correct === !0 && P(), r.stack.length > 0 && r.stack.token !== "object" && V(!0), N.objectSort === !0 && r.stack.token === "object" && jt(e), S === "comment" && (p = e.token[r.count], S = e.types[r.count]), p = "}"), r.stack.token === "data_type" ? S = "type_end" : S = "end", o.pop(), C = r.stack.entry, i(y, 41) && n.correct === !0 && $ - r.count < 2 && (i(e.token[r.count], 40) || e.types[r.count] === "number") && (e.token[$ - 1] === "Array" || e.token[$ - 1] === "Object") && e.token[$ - 2] === "new" && (ge(), A = !0), b[b.length - 1] === "x{" && i(y, 125) ? (oe(), b.pop(), e.stack[r.count] !== "try" && M(v, 58) && M(v, 59) && e.token[e.begin[m] - 1] !== "?" && oe(), p = "}") : b.pop(), N.endComma !== void 0 && N.endComma !== "none" && r.stack.token === "array" || r.stack.token === "object" || r.stack.token === "data_type")
      if (N.endComma === "always" && M(e.token[r.count], 44)) {
        ...
        if (pe > ne) {
          let q = S, E = p;
          p = ",", S = "separator", R(), p = E, S = q;
        }
      } else
        N.endComma === "never" && i(e.token[r.count], 44) && r.pop(e);
    A === !1 && (R(), i(p, 125) && e.stack[r.count] !== "object" && e.stack[r.count] !== "class" && e.stack[r.count] !== "data_type" && (s.pop(), oe())), w === !0 && (p = n.correct === !0 ? "{" : "x{", S = "start", R(I[0]), b.push("x{"), I[1] = r.count), h.pop(), r.stack.token !== "data_type" && (h[h.length - 1] = !1);
  }
  function _(y) {
    let w = r.count, A = c, v = c, $ = c, ge = !1;
    if (b.push(y), i(y, 123) && (e.types[r.count] === "type" || e.types[r.count] === "type_end" || e.types[r.count] === "generic")) {
      let ne = 0;
    ...
    if (d > -1 && (k(), w = r.count), le > -1 && (F.count[le] = F.count[le] + 1), e.token[w - 1] === "function" ? o.push(["function", w + 1]) : o.push([p, w + 1]), p = y, h[h.length - 1] === !0 ? S = "type_start" : S = "start", i(y, 40) || y === "x(" ? ke() : i(y, 91) && (a > -1 ? (e.begin[a - 1] === e.begin[e.begin[w] - 1] || e.token[e.begin[w]] === "x(") && (a = -1, n.correct === !0 ? ee(")") : ee("x)"), ke(), p = "{", S = "start") : i(p, 41) && ke(), S === "comment" && i(e.token[w - 1], 41) && (p = e.token[w], e.token[w] = "{", S = e.types[w], e.types[w] = "start")), A = (() => {
      let ne = r.count;
    ...
    if (S === "type_start")
      ...
      if (A === "else" || A === "do" || A === "try" || A === "finally" || A === "switch")
        ...
        $ = "object";
      else if (i(A, 41) && (I[0] === "function" || I[0] === "if" || I[0] === "for" || I[0] === "class" || I[0] === "while" || I[0] === "switch" || I[0] === "catch"))
        $ = I[0];
        ...
        $ = "function";
      else if (e.types[I[1] - 1] === "markup" && e.token[I[1] - 3] === "function")
        $ = "function";
      else if (A === "=>")
        $ = "function";
    ...
    R($), f.length > 0 && (f[f.length - 1] = f[f.length - 1] + 1);
  }
  function Q(y) {
    let w = 2, A = 0, v = c, $ = y.slice(0, 2), ge = y.length;
    if (i(y[2], 45) && (w = w + 1), ue(y.charAt(w)) === !0)
      do
        w = w + 1;
      while (ue(y.charAt(w)) === !0 && w < ge);
    A = w;
    do
      A = A + 1;
    while (ue(y.charAt(A)) === !1 && y.charAt(A) !== "(" && A < ge);
    if (A === ge && (A = y.length - 2), v = y.slice(w, A), v === "else" || $ === "{%" && (v === "elseif" || v === "when" || v === "elif" || v === "elsif"))
  ...
  function k() {
    ...
    if (p.charAt(0) === "\u201C" ? r.error = `Quote looking character (\u201C, \\u201c) used instead of actual quotes on line number ${r.lineNumber}` : p.charAt(0) === "\u201D" && (r.error = `Quote looking character (\u201D, \\u201d) used instead of actual quotes on line number ${r.lineNumber}`), A = ne.join(c), d = -1, r.count > 0 && A === "function" && i(e.token[r.count], 40) && (i(e.token[r.count - 1], 123) || e.token[r.count - 1] === "x{") && (e.types[r.count] = "start"), r.count > 1 && A === "function" && i(p, 40) && (i(e.token[r.count - 1], 125) || e.token[r.count - 1] === "x}"))
      if (i(e.token[r.count - 1], 125)) {
        if (y = r.count - 2, y > -1)
          do {
            if (e.types[y] === "end" ? w = w + 1 : (e.types[y] === "start" || e.types[y] === "end") && (w = w - 1), w === 0)
              break;
            y = y - 1;
          } while (y > -1);
    ...
    if (n.correct === !0 && (A === "Object" || A === "Array") && i(l[m + 1], 40) && i(l[m + 2], 41) && i(e.token[r.count - 1], 61) && e.token[r.count] === "new")
      ...
      if (w = r.count, y = w, N.variableList !== "none" && (A === "var" || A === "let" || A === "const")) {
        ...
        le = le + 1, F.count.push(0), F.index.push(w), F.word.push(A), w = y;
      } else
        le > -1 && A !== F.word[le] && r.count === F.index[le] && i(e.token[F.index[le]], 59) && p !== F.word[le] && N.variableList === "list" && x();
      ...
      if (v = G(2, !1), A === "void")
        ...
        S = "reference", s[s.length - 1].push(A), r.language === "javascript" || r.language === "jsx" || r.language === "typescript" || r.language === "tsx" ? $ === "var" || $ === "function" && e.types[r.count - 1] !== "operator" && e.types[r.count - 1] !== "start" && e.types[r.count - 1] !== "end" ? q(r.count, A, !0) : q(r.count, A, !1) : q(r.count, A, !1);
        ...
        s.length > 0 && e.token[E] === "var" ? (S = "reference", s[s.length - 1].push(A), r.language === "javascript" || r.language === "jsx" || r.language === "typescript" || r.language === "tsx" ? q(E, A, !0) : q(E, A, !1)) : s.length > 0 && (e.token[E] === "let" || e.token[E] === "const" || e.token[E] === "type" && (r.language === "typescript" || r.language === "tsx")) ? (S = "reference", s[s.length - 1].push(A), q(E, A, !1)) : S = "word";
    ...
    if (R(), A === "class" && f.push(0), A === "do" && (v = G(1, !0), v !== "{" && (p = n.correct === !0 ? "{" : "x{", S = "start", b.push("x{"), R("do"))), A === "else") {
      v = G(2, !0);
      let E = r.count - 1;
      ...
      }), r.stack.length > 1 && (r.stack.splice(r.stack.length - 2, 1), r.stack.update(r.count))) : (e.token[r.count - 2] === "x}" && C[0] !== "if" && e.stack[r.count] === "else" || e.token[r.count - 2] === "}" && e.stack[r.count - 2] === "if" && C[0] === "if" && e.token[C[1] - 1] !== "if" && e.token[e.begin[r.count - 1]] === "x{") && pe() : e.token[r.count] === "x}" && e.stack[r.count] === "if" && pe()), v !== "if" && M(v, 123) && (p = n.correct === !0 ? "{" : "x{", S = "start", b.push("x{"), R("else"));
    }
  ...
  do
    ue(l[m]) ? (d > -1 && k(), K(), r.lineOffset > 1 && D < r.count && M(l[m + 1], 59) && M(l[m + 1], 125) && (V(!1), D = r.count)) : i(l[m], 123) && i(l[m + 1], 37) ? T("{%", "%}", "liquid") : i(l[m], 123) && i(l[m + 1], 123) ? T("{{", "}}", "liquid") : i(l[m], 60) && i(l[m + 1], 33) && i(l[m + 2], 45) && i(l[m + 3], 45) ? T("<!--", "-->", "comment") : i(l[m], 60) ? J() : i(l[m], 47) && (m === O - 1 || i(l[m + 1], 42)) ? ae() : (r.count < 0 || e.lines[r.count] > 0) && i(l[m], 35) && i(l[m + 1], 33) && (i(l[m + 2], 47) || i(l[m + 3], 91)) ? T("#!" + l[m + 2], H, "string") : i(l[m], 47) && (m === O - 1 || i(l[m + 1], 47)) ? L() : i(l[m], 96) || i(l[m], 125) && r.stack.token === "template_string" ? (d > -1 && k(), p = ce(), i(p, 125) && p.slice(p.length - 2) === "${" ? (S = "template_string_else", R("template_string")) : p.slice(p.length - 2) === "${" ? (S = "template_string_start", R("template_string")) : i(p[0], 125) ? (S = "template_string_end", R()) : (S = "string", R())) : i(l[m], 34) || i(l[m], 39) ? T(l[m], l[m], "string") : i(l[m], 45) && m < O - 1 && M(l[m + 1], 61) && M(l[m + 1], 45) && (S === "number" || S === "word" || S === "reference") && p !== "return" && (S === "word" || S === "reference" || S === "number" || i(p, 41) || i(p, 93)) ? (d > -1 && k(), p = "-", S = "operator", R()) : d === -1 && (l[m] !== "0" || l[m] === "0" && l[m + 1] !== "b") && (He(l[m]) || m !== O - 2 && i(l[m], 45) && i(l[m + 1], 46) && He(l[m + 2]) || m !== O - 1 && (i(l[m], 45) || i(l[m], 46)) && He(l[m + 1])) ? (d > -1 && k(), S === "end" && i(l[m], 45) ? (p = "-", S = "operator") : (p = me(), S = "number"), R()) : i(l[m], 58) && i(l[m + 1], 58) ? (d > -1 && k(), n.correct === !0 && P(), ke(), m = m + 1, p = "::", S = "separator", R()) : i(l[m], 44) ? (d > -1 && k(), n.correct === !0 && P(), h[h.length - 1] === !0 && e.stack[r.count].indexOf("type") < 0 && (h[h.length - 1] = !1), S === "comment" ? se() : le > -1 && F.count[le] === 0 && N.variableList === "each" ? (ke(), p = ";", S = "separator", R(), p = F.word[le], S = "word", R(), F.index[le] = r.count) : (p = ",", S = "separator", ke(), R())) : i(l[m], 46) ? (d > -1 && k(), h[h.length - 1] = !1, i(l[m + 1], 46) && i(l[m + 2], 46) ? (p = "...", S = "operator", m = m + 2) : (ke(), p = ".", S = "separator"), ue(l[m - 1]) && (r.lineOffset = 1), R()) : i(l[m], 59) ? (d > -1 && k(), h[h.length - 1] === !0 && e.stack[r.count].indexOf("type") < 0 && (h[h.length - 1] = !1), f[f.length - 1] === 0 && f.pop(), le > -1 && F.count[le] === 0 && (N.variableList === "each" ? x() : F.index[le] = r.count + 1), n.correct === !0 && P(), p = ";", S = "separator", e.token[r.count] === "x}" ? we() : R(), oe()) : i(l[m], 40) || i(l[m], 91) || i(l[m], 123) ? _(l[m]) : i(l[m], 41) || i(l[m], 93) || i(l[m], 125) ? ee(l[m]) : d < 0 && e.stack[r.count] === "object" && i(l[m], 42) && M(l[m + 1], 61) && He(l[m + 1]) === !1 && ue(l[m + 1]) === !1 ? d = m : i(l[m], 61) || i(l[m], 38) || i(l[m], 60) || i(l[m], 62) || i(l[m], 43) || i(l[m], 45) || i(l[m], 42) || i(l[m], 47) || i(l[m], 33) || i(l[m], 63) || i(l[m], 124) || i(l[m], 94) || i(l[m], 58) || i(l[m], 37) || i(l[m], 94) ? (p = ie(), p === "regex" ? p = e.token[r.count] : i(p, 42) && e.token[r.count] === "function" ? e.token[r.count] = "function*" : (S = "operator", M(p, 33) && p !== "++" && p !== "--" && ke(), R())) : d < 0 && l[m] !== c && (d = m), le > -1 && r.count === F.index[le] + 1 && i(e.token[F.index[le]], 59) && p !== F.word[le] && S !== "comment" && N.variableList === "list" && x(), m = m + 1;
  while (m < O);
  return d > -1 && k(), (M(e.token[r.count], 125) && i(e.token[0], 123) || M(e.token[0], 123)) && (M(e.token[r.count], 93) && i(e.token[0], 91) || M(e.token[0], 91)) && V(!1), t[0] === r.count && (p = H + t[1], S = "string", R()), e.token[r.count] === "x;" && (i(e.token[r.count - 1], 125) || i(e.token[r.count - 1], 93)) && e.begin[r.count - 1] === 0 && r.pop(e), N.objectSort && e.begin.length > 0 && Qt(0, r.count + 1), e;
}
...
function cn() {
  ...
  function F(a) {
    let g = a.replace(/\s*!important/, " !important").split(c), W = /-?transition$/.test(e.token[r.count - 2]), C = [], U = /(\s|\(|,)-?0+\.?\d+([a-z]|\)|,|\s)/g, j = /(\s|\(|,)-?\.?\d+([a-z]|\)|,|\s)/g, x = 0, R = 0, G = c, B = g.length, V = [], ke = (ie) => ie;
    function we(ie) {
      return ie = ie.replace(/\s*/g, c), /\/\d/.test(ie) && a.indexOf("url(") === 0 ? ie : ` ${ie.charAt(0)} ${ie.charAt(1)}`;
    }
    function ae(ie) {
      return s.style.noLeadZero === !0 ? ie.replace(/^-?\D0+(\.|\d)/, (ce) => ce.replace(/0+/, c)) : /0*\./.test(ie) ? ie.replace(/0*\./, "0.") : /0+/.test(/\d+/.exec(ie)[0]) ? /^\D*0+\D*$/.test(ie) ? ie.replace(/0+/, "0") : ie.replace(/\d+/.exec(ie)[0], /\d+/.exec(ie)[0].replace(/^0+/, c)) : ie;
    }
    function L(ie) {
      return ie.replace(",", ", ");
    }
    ...
    if (x < B)
      do
        V.push(g[x]), (M(g[x - 1], 92) || me() === !1) && (G === c ? i(g[x], 34) ? (G = Be, R = R + 1) : i(g[x], 39) ? (G = $e, R = R + 1) : i(g[x], 40) ? (G = ")", R = R + 1) : i(g[x], 91) && (G = "]", R = R + 1) : i(g[x], 40) && i(G, 41) || i(g[x], 91) && i(G, 93) ? R = R + 1 : g[x] === G && (R = R - 1, R === 0 && (G = c))), G === c && i(g[x], 32) && (V.pop(), C.push(ke(V.join(c))), V = []), x = x + 1;
      while (x < B);
    if (C.push(ke(V.join(c))), B = C.length, x = 0, x < B)
      do
        s.style.noLeadZero === !0 && /^-?0+\.\d+[a-z]/.test(C[x]) === !0 ? C[x] = C[x].replace(/0+\./, ".") : s.style.noLeadZero === !1 && /^-?\.\d+[a-z]/.test(C[x]) ? C[x] = C[x].replace(".", "0.") : U.test(C[x]) || j.test(C[x]) ? C[x] = C[x].replace(U, ae).replace(j, ae) : /^(0+([a-z]{2,3}|%))$/.test(C[x]) && W === !1 ? C[x] = "0" : /^(0+)/.test(C[x]) ? (C[x] = C[x].replace(/0+/, "0"), /\d/.test(C[x].charAt(1)) && (C[x] = C[x].substr(1))) : /^url\((?!('|"))/.test(C[x]) && C[x].charCodeAt(C[x].length - 1) === 41 && (G = C[x].charAt(C[x].indexOf("url(") + 4), G !== "@" && M(G, 40) && M(G, 60) && (s.style.quoteConvert === "double" ? C[x] = C[x].replace(/url\(/, 'url("').replace(/\)$/, '")') : C[x] = C[x].replace(/url\(/, "url('").replace(/\)$/, "')"))), /^(\+|-)?\d+(\.\d+)?(e-?\d+)?\D+$/.test(C[x]) && (Le.css.units.has(C[x].replace(/(\+|-)?\d+(\.\d+)?(e-?\d+)?/, c)) || (C[x] = C[x].replace(/(\+|-)?\d+(\.\d+)?(e-?\d+)?/, ye))), /^\w+\(/.test(C[x]) && C[x].charAt(C[x].length - 1) === ")" && (C[x].indexOf("url(") !== 0 || C[x].indexOf("url(") === 0 && C[x].indexOf(te) > 0) && (C[x] = C[x].replace(/,\S/g, L)), x = x + 1;
      while (x < B);
    return G = C.join(te), G.charAt(0) + G.slice(1).replace(/\s*(\/|\+|\*)\s*(\d|\$)/, we);
  }
  function le() {
    let a = [], g = [], W = s.style.quoteConvert, C = o, U = 0, j = c, x = null, R = !1;
    function G() {
    ...
    if (C < N)
      do {
        if (i(u[C], 34) || i(u[C], 39) ? (x === null && (x = !1), a[a.length - 1] === u[C] && (M(u[C - 1], 92) || h(C - 1) === !1) ? (a.pop(), W === "double" ? u[C] = Be : W === "single" && (u[C] = $e)) : M(a[a.length - 1], 34) && M(a[a.length - 1], 39) && (M(u[C - 1], 92) || h(C - 1) === !1) ? (a.push(u[C]), W === "double" ? u[C] = Be : W === "single" && (u[C] = $e)) : i(u[C - 1], 92) && W !== "none" ? h(C - 1) === !0 && (W === "double" && i(u[C], 39) || W === "single" && i(u[C], 34)) && g.pop() : W === "double" && i(u[C], 34) ? u[C] = '\\"' : W === "single" && i(u[C], 39) && (u[C] = "\\'"), g.push(u[C])) : M(u[C - 1], 92) || h(C - 1) === !1 ? i(u[C], 40) ? (x === null && (x = !0), a.push(")"), G()) : i(u[C], 91) ? (x = !1, a.push("]"), G()) : (i(u[C], 35) || i(u[C], 64)) && i(u[C + 1], 123) ? (x = !1, g.push(u[C]), C = C + 1, a.push("}"), G()) : u[C] === a[a.length - 1] ? (g.push(u[C]), a.pop()) : g.push(u[C]) : g.push(u[C]), r.stack.token === "map" && a.length === 0 && (i(u[C + 1], 44) || i(u[C + 1], 41)))
    ...
    o = C, r.stack.token === "map" && i(g[0], 40) && (l[l.length - 1] = l[l.length - 1] - 1), f = g.join(c).replace(/\s+/g, te).replace(/^\s/, c).replace(/\s$/, c), x === !0 && (r.count > -1 && Le.css.atrules(f) && s.style.atRuleSpace === !0 ? e.token[r.count] = e.token[r.count].replace(/\s*\(/g, " (").replace(/\s*\)\s*/g, ") ").replace(/,\(/g, ", (") : f = f.replace(/\s+\(/g, "(").replace(/\s+\)/g, ")").replace(/,\(/g, ", (")), b === "colon" && e.types[r.count - 1] === "start" ? Le.css.pseudoClasses.has(f) && (e.token[r.count] = f = ":" + f, b = "pseudo", R = !0) : r.count > -1 && e.token[r.count].indexOf("extend(") === 0 ? b = "pseudo" : x === !0 && He(f.charAt(0)) === !1 && /^rgba?\(/.test(f) === !1 && f.indexOf("url(") !== 0 && (f.indexOf(te) < 0 || f.indexOf(te) > f.indexOf("(")) && f.charAt(f.length - 1) === ")" ? (i(e.token[r.count], 58) ? b = "value" : (f = f.replace(/,\u0020?/g, ", "), b = "function"), f = F(f)) : r.count > -1 && $e.indexOf(e.token[r.count].charAt(0)) > -1 && e.types[r.count] === "variable" ? b = "item" : i(g[0], 64) || g[0] === "$" ? (e.types[r.count] === "colon" && s.language === "css" && (e.types[r.count - 1] === "property" || e.types[r.count - 1] === "variable") ? b = "value" : r.count > -1 && (b = "item", j = e.token[r.count], C = j.indexOf("("), i(j[j.length - 1], 41) && C > 0 && (j = j.slice(C + 1, j.length - 1), e.token[r.count] = e.token[r.count].slice(0, C + 1) + F(j) + ")")), f = F(f)) : b = "item", R === !1 ? t(c) : R = !1;
  }
  function m(a) {
    ...
    function R(G) {
      ...
      if (e.token[G] = e.token[G].replace(/\s*&/, " &").replace(/\s*&\s*{/, " & {").replace(/\s*>\s*/g, " > ").replace(/\s*\+\s*/g, " + ").replace(/:\s+/g, ": ").replace(/^\s+/, c).replace(/\s+$/, c).replace(/\s+::\s+/, "::"), i(e.token[B], 64) && (e.token[G] = e.token[G].replace(/(\(\s*[a-z-]+\s*)(:)(\S)/g, "$1$2 $3")), M(e.token[B], 44) && e.types[B] !== "comment" && (e.types[B] = "selector"), i(e.token[B - 1], 44) || i(e.token[B - 1], 58) || e.types[B - 1] === "comment" || e.types[B - 1] === "pseudo")
        if (e.types[B - 1] === "colon" && (e.types[B] === "selector" || e.types[B] === "at_rule") && (e.types[B - 2] === "template" || e.types[B - 2] === "liquid_start" || e.types[B - 2] === "liquid_else" || e.types[B - 2] === "liquid_end"))
          e.token[B - 1] = ":" + e.token[B] + te, e.types[B - 1] = "selector", r.splice({
            data: e,
            howmany: 1,
            index: B
          });
          ...
          e.token[B - 1] = x(`${e.token[B - 1]}${e.token[B]}`), e.types[B - 1] = "selector", r.splice({
            data: e,
            howmany: 1,
            index: B
          });
          ...
          do
            if (B = B - 1, e.begin[B] === V) {
              if (i(e.token[B], 59))
                break;
              M(e.token[B], 44) && e.types[B] !== "comment" && (e.types[B] = "selector"), e.token[B] === ":" && M(e.token[B - 1], 59) && (e.token[B - 1] = x(`${e.token[B - 1]}:${e.token[B + 1]}`), r.splice({
                data: e,
                howmany: 2,
                index: B
              }));
    ...
    if (j(), a === "start" && (e.types[g] === "value" || e.types[g] === "variable") && (e.types[g] = "item"), e.lexer[r.count - 1] !== "style" || W < 0)
      a === "colon" ? i(C, 36) || i(C, 64) ? e.types[g] = "variable" : e.stack[g] !== "global" && (e.types[g] !== "comment" || e.types[g] !== "ignore") && (e.types[g] = "property") : e.lexer[g] === "style" && (e.types[g] = "selector", R(g));
    else if (a === "start" && e.types[g] === "function" && e.lexer[g] === "style")
      e.types[g] = "selector", R(g);
    else if (e.types[g] === "item" && e.lexer[g] === "style")
      if (a === "start")
        R(g), e.types[g] = "selector", e.token[g] === ":" && (e.types[W] = "selector"), e.token[g].indexOf("=\u201C") > 0 ? r.error = `Invalid Quote (\u201C, \\201c) used on line number ${r.lineNumber}` : e.token[g].indexOf("=\u201D") > 0 && (r.error = `Invalid Quote (\u201D, \\201d) used on line number ${r.lineNumber}`);
      else if (a === "end")
          ...
          if (i(u[o], 34))
            ...
            if (j === g.length) {
              ...
              if (j === C.length && (j = j - g.length), a === "{%" && (U = Ue(C)), b === "item" && e.types[r.count - 1] === "colon" && (e.types[r.count - 2] === "property" || e.types[r.count - 2] === "variable")) {
                b = "value", e.types[r.count] = "value", Number.isNaN(Number(e.token[r.count])) === !0 && e.token[r.count].charAt(e.token[r.count].length - 1) !== ")" ? e.token[r.count] = e.token[r.count] + C : e.token[r.count] = e.token[r.count] + te + C;
                return;
              }
              if (f = C, a === "{%") {
                let G = Array.from(Le.liquid.tags), B = G.length - 1, V = U.slice(0, U.indexOf(te) + 1);
                ...
                do
                  V = V + 1;
                while (V < B && ue(G.charAt(V)) === !1 && G.charCodeAt(x) !== 40);
  ...
  function I(a) {
    ...
    a ? (g = Ht({
      ...
      begin: "//",
      ender: H
    }), f = g[0], b = Dt.test(f) ? "ignore" : "comment") : (g = wt(u, {
      start: o,
      end: N,
      lexer: "style",
      begin: "/*",
      ender: "*/"
    }), f = g[0], b = ji.test(f) ? "ignore" : "comment"), t(c), o = g[1];
  }
  function D() {
    ...
    function C(R) {
      if (e.token[j - 2] === R) {
        let G = e.token[j].replace(/\s*!important\s*/g, c).split(te), B = G.length;
        e.token[j].indexOf("!important") > -1 && (g.data[R[4]] = !0), B > 3 ? (g.data[R][0] === c && (g.data[R][0] = G[0]), g.data[R][1] === c && (g.data[R][1] = G[1]), g.data[R][2] === c && (g.data[R][2] = G[2]), g.data[R][3] === c && (g.data[R][3] = G[3])) : B > 2 ? (g.data[R][0] === c && (g.data[R][0] = G[0]), g.data[R][1] === c && (g.data[R][1] = G[1]), g.data[R][2] === c && (g.data[R][2] = G[2]), g.data[R][3] === c && (g.data[R][3] = G[1])) : B > 1 ? (g.data[R][0] === c && (g.data[R][0] = G[0]), g.data[R][1] === c && (g.data[R][1] = G[1]), g.data[R][2] === c && (g.data[R][2] = G[0]), g.data[R][3] === c && (g.data[R][3] = G[1])) : (g.data[R][0] === c && (g.data[R][0] = G[0]), g.data[R][1] === c && (g.data[R][1] = G[0]), g.data[R][2] === c && (g.data[R][2] = G[0]), g.data[R][3] === c && (g.data[R][3] = G[0]));
      } else if (e.token[j - 2] === `${R}-bottom`)
        g.data[R][2] === c && (g.data[R][2] = e.token[j]);
      else if (e.token[j - 2] === `${R}-left`)
        g.data[R][3] === c && (g.data[R][3] = e.token[j]);
      else if (e.token[j - 2] === `${R}-right`)
        g.data[R][1] === c && (g.data[R][1] = e.token[j]);
      else if (e.token[j - 2] === `${R}-top`)
        g.data[R][0] === c && (g.data[R][0] = e.token[j]);
      else
        return;
      g.removes.push([j, R]), g.last[R] = j;
    }
    function U() {
      let R = 0, G = c, B = /^(0+([a-z]+|%))/, V = g.removes.length, ke = g.data.margin[0] !== c && g.data.margin[1] !== c && g.data.margin[2] !== c && g.data.margin[3] !== c, we = g.data.padding[0] !== c && g.data.padding[1] !== c && g.data.padding[2] !== c && g.data.padding[3] !== c;
      function ae(L) {
        if (B.test(g.data[L][0]) === !0 && (g.data[L][0] = "0"), B.test(g.data[L][1]) === !0 && (g.data[L][1] = "0"), B.test(g.data[L][2]) === !0 && (g.data[L][2] = "0"), B.test(g.data[L][3]) === !0 && (g.data[L][3] = "0"), g.data[L][0] === g.data[L][1] && g.data[L][0] === g.data[L][2] && g.data[L][0] === g.data[L][3] ? G = g.data[L][0] : g.data[L][0] === g.data[L][2] && g.data[L][1] === g.data[L][3] && g.data[L][0] !== g.data[L][1] ? G = `${g.data[L][0]} ${g.data[L][1]}` : g.data[L][1] === g.data[L][3] && g.data[L][0] !== g.data[L][2] ? G = `${g.data[L][0]} ${g.data[L][1]} ${g.data[L][2]}` : G = `${g.data[L][0]} ${g.data[L][1]} ${g.data[L][2]} ${g.data[L][3]}`, g.data[L[4]] === !0 && (G = `${G.replace(" !important", c)} !important`), g.last[L] > r.count) {
          R = W < 1 ? 1 : W + 1;
          do {
            if (e.begin[R] === W && e.types[R] === "value" && e.token[R - 2].indexOf(L) === 0) {
              g.last[L] = R;
              break;
            }
            R = R + 1;
      ...
      if (V > 1 && (ke === !0 || we === !0))
        do
          g.removes[R][0] !== g.last.margin && g.removes[R][0] !== g.last.padding && (ke === !0 && g.removes[R][1] === "margin" || we === !0 && g.removes[R][1] === "padding") && r.splice({
            data: e,
            howmany: e.types[g.removes[R][0] + 1] === "separator" ? 4 : 3,
            index: g.removes[R][0] - 2
          }), R = R + 1;
        while (R < V - 1);
      ke === !0 && ae("margin"), we === !0 && ae("padding"), x === !0 && (W < 0 ? r.error = "Brace mismatch. There appears to be more closing braces than starting braces." : Qt(W, r.count + 1));
    }
    let j = r.count, x = !1;
    do
      j = j - 1, e.begin[j] === W ? e.types[j] === "value" && e.types[j - 2] === "property" && (e.token[j - 2].indexOf("margin") === 0 ? C("margin") : e.token[j - 2].indexOf("padding") === 0 && C("padding")) : (x = !0, j = e.begin[j]);
    while (j > W);
    U(), r.lineOffset = a;
  }
  function d() {
...
function pn() {
  ...
  function U() {
    ...
    f.lines[n + 1] = 0;
    do
      d(n, "comment") ? (Q === 0 && (i(f.token[n][1], 37) && e.liquid.commentNewline === !0 || i(f.token[n][1], 37) === !1 && e.markup.commentNewline === !0) && (e.preserveLine === 0 || D.length > 0 && D[D.length - 1].lastIndexOf(H) + 1 < 2) && D.push(C(_)), P[Q] !== c ? (Q > 0 && (i(f.token[n][1], 37) && e.liquid.commentIndent === !0 || i(f.token[n][1], 37) === !1 && e.markup.commentIndent === !0) && D.push(I), P[Q + 1].trimStart() !== c ? D.push(P[Q], C(_)) : D.push(P[Q], H)) : P[Q + 1].trimStart() === c ? D.push(H) : D.push(C(_))) : se ? s === "align" || s === "force-align" ? D.push(P[Q].trim(), C(S[n])) : s === "indent" || s === "force-indent" ? Q + 1 === ee ? D.push(P[Q].trimEnd(), C(S[n])) : Q === 0 ? D.push(P[Q].replace(/(["'])\s+/, "$1" + C(_)).trim(), C(_)) : D.push(P[Q], C(_)) : (D.push(P[Q]), s === "force-preserve" && (Q + 1 === ee || Q === 0) ? D.push(C(S[n])) : D.push(r.crlf)) : D.push(P[Q], C(_)), Q = Q + 1;
    while (Q < ee);
    if (se && M(P[ee], 60) && m.get(n - 1) >= 2 && Qe(P[ee], 62) && e.markup.delimiterTerminus !== "inline") {
      m.delete(n - 1);
      let k = C(S[n - 1] - 1);
      D[D.length - 1] === k && D.push(e.indentChar.repeat(e.indentSize)), d(n - 1, "singleton") && mt(P[ee], 47) ? D.push(P[ee].slice(0, -2), k, "/>") : D.push(P[ee].slice(0, -1), k, ">");
    } else
      D.push(P[ee]);
    f.lines[n + 1] = T, d(n, "comment") && (d(n + 1, "liquid_end") || d(n - 1, "liquid_end")) ? D.push(C(S[n])) : S[n] === -10 ? D.push(te) : D.push(C(S[n]));
  }
  function j() {
  ...
  function R() {
    let P = f.token[n], T = si.exec(P);
    if (T === null)
      return;
    let oe = n + 1, se = !1, ee = e.markup.selfCloseSpace === !0 && T[0] === "/>" ? te : c;
    f.token[n] = P.replace(si, c);
    do {
  ...
  function ke() {
    ...
    if (O < t && (W(O, "end") > -1 || W(O, "start") > -1) && f.lines[O] > 0 ? (p.push(b), P = P + 1, n > 0 && d(n, "singleton") && W(n - 1, "attribute") > -1 && d(f.begin[n - 1], "singleton") && (f.begin[n] < 0 || d(f.begin[n - 1], "singleton") && f.begin[f.ender[n] - 1] !== n ? p[n - 1] = b : p[n - 1] = b + 1)) : n > 0 && d(n, "singleton") && W(n - 1, "attribute") > -1 ? (p[n - 1] = b, o = f.token[n].length, p.push(-10)) : f.lines[O] === 0 ? p.push(-20) : (e.wrap === 0 || n < t - 2 && f.token[n] !== void 0 && f.token[n + 1] !== void 0 && f.token[n + 2] !== void 0 && f.token[n].length + f.token[n + 1].length + f.token[n + 2].length + 1 > e.wrap && W(n + 2, "attribute") > -1 || f.token[n] !== void 0 && f.token[n + 1] !== void 0 && f.token[n].length + f.token[n + 1].length > e.wrap) && (d(n + 1, "singleton") || d(n + 1, "liquid")) ? p.push(b) : (o = o + 1, p.push(-10)), n > 0 && W(n - 1, "attribute") > -1 && f.lines[n] < 1 && (p[n - 1] = -20), o > e.wrap) {
      ...
      if (d(n, "content") && e.markup.preserveText === !1) {
        let se = 0, ee = f.token[n].replace(Ye, te).split(te);
        do
          if (T = T - 1, p[T] < 0)
  ...
  function we() {
    ...
    h[P] = n, f.types[n + 1] === "script_end" && f.token[n + 1] === "}" ? p.push(-20) : (f.types[n + 1], p.push(b - 1)), O = x(), f.lexer[O] === "markup" && f.stack[n].indexOf("attribute") < 0 && (f.types[O] === "end" || f.types[O] === "liquid_end") && (b = b - 1);
  }
  function ae(P) {
    let T = f.token[P].replace(/\s+/g, te).split(te), oe = T.length, se = 1, ee = T[0].length;
    do
  ...
  function L() {
    let P = n - 1, T = n, oe = !1, se = !1, ee = W(P + 1, "end"), _ = f.token[P].length + 1, Q = 0, k = (() => {
      if (W(n, "start") > 0) {
        let y = n;
        do {
          if (d(y, "end") && f.begin[y] === n && y < t - 1 && W(y + 1, "attribute") > -1) {
            oe = !0;
            break;
          }
          y = y + 1;
    ...
    function K(y) {
      e.markup.forceAttribute === !1 ? p.push(-10) : e.markup.forceAttribute === !0 || y >= e.markup.forceAttribute ? e.liquid.indentAttribute === !0 ? (d(n - 1, "liquid_attribute_start") && (p[n - 1] = k + Q), p.push(k + Q)) : p.push(k) : p.push(-10);
    }
    k < 1 && (k = 1), ee = 0;
    do
      ee = ee + 1;
    while (W(n + ee, "attribute") > -1 && (d(n + ee, "end") === !1 || d(n + ee, "liquid_when") === !1 || d(n + ee, "singleton") === !1 || d(n + ee, "start") === !1 || d(n + ee, "comment") === !1));
    (s === "force-preserve" || s === "force-align" || s === "force-indent") && (ht(e.markup.forceAttribute) && e.markup.forceAttribute === !1 || xt(e.markup.forceAttribute) && ee <= e.markup.forceAttribute) && (ee = 1 / 0);
    do {
    ...
    if (n = n - 1, W(n, "liquid") < 0 && W(n, "end") > -1 && W(n, "attribute") > 0 && d(P, "singleton") === !1 && p[n - 1] > 0 && oe === !0 && (p[n - 1] = p[n - 1] - 1), p[n] !== -20 && (F === !0 && W(P, "start") > -1 && d(n + 1, "script_start") ? p[n] = k : g(n, "/") && p[n - 1] !== 10 ? p[n - 1] = -10 : p[n] = p[P]), e.markup.forceAttribute === !0)
      ...
      if (ee >= e.markup.forceAttribute) {
        ...
        let y = n - 1;
        do
          (d(y, "liquid") && p[y] === -10 || d(y, "attribute") && p[y] === -10) && (p[y] = k), y = y - 1;
        while (y > P);
  ...
  function ye() {
    do
      f.lexer[n] === "markup" ? (d(n, "doctype") && (p[n - 1] = b), W(n, "attribute") > -1 ? L() : d(n, "comment") ? (N < 0 && (N = n), V()) : d(n, "comment") === !1 && (O = x(), (d(O, "end") || d(O, "liquid_case_end") || d(O, "liquid_end") && d(n, "liquid_else") === !1) && (b > -1 && (b = b - 1), (g(n, "</ol>") || g(n, "</ul>") || g(n, "</dl>")) && B()), d(n, "script_end") && d(O, "end") ? f.lines[O] < 1 ? p.push(-20) : f.lines[O] > 1 ? p.push(b) : p.push(-10) : (e.markup.forceIndent === !1 || e.markup.forceIndent === !0 && d(O, "script_start")) && (d(n, "content") || d(n, "singleton") || d(n, "liquid")) ? (o = o + f.token[n].length, f.lines[O] > 0 && d(O, "script_start") ? p.push(-10) : e.wrap > 0 && d(n, "singleton") === !1 && (W(n, "liquid") < 0 || O < t && W(n, "liquid") > -1 && W(O, "liquid") < 0) ? ke() : O < t && (W(O, "end") > -1 || W(O, "start") > -1) && (f.lines[O] > 0 || W(n, "liquid_") > -1) ? (d(O, "liquid_case_end") && le.has("case") === !1 && (b = b - 1), p.push(b)) : f.lines[O] === 0 ? p.push(-20) : f.lines[O] === 1 ? p.push(-10) : (d(O, "liquid_when") && (d(n, "liquid") || d(n, "content")) && (b = b - 1), p.push(b))) : d(n, "start") || d(n, "liquid_start") || d(n, "liquid_bad_start") ? (b = b + 1, F === !0 && i(f.token[n + 1], 123) ? f.lines[O] === 0 ? p.push(-20) : f.lines[O] > 1 ? p.push(b) : p.push(-10) : d(n, "start") && d(O, "end") ? f.stack[n] === "liquid" || W(O - 1, "comment") > -1 ? p.push(b) : p.push(-20) : d(n, "start") && d(O, "script_start") ? p.push(-10) : f.lines[O] === 0 && (d(O, "content") || d(O, "singleton") || d(n, "start") && d(O, "liquid") && e.markup.forceIndent === !1) ? d(O, "content") ? ke() : p.push(-20) : p.push(b)) : e.markup.forceIndent === !1 && f.lines[O] === 0 && (d(O, "content") || d(O, "singleton")) || d(n + 2, "script_end") ? p.push(-20) : d(n, "liquid_else") && d(O, "liquid_end") ? (b = b - 1, p[n - 1] = b, p.push(b)) : d(n, "liquid_else") && d(O, "liquid_else") ? (p[n - 1] = b - 1, p.push(b - 1)) : d(n, "liquid_else") && (d(O, "content") || d(O, "liquid")) ? (p[n - 1] = b - 1, p.push(b)) : e.markup.forceIndent === !0 && (d(n, "content") && (d(O, "liquid") || d(O, "content")) || d(n, "liquid") && (d(O, "content") || d(O, "liquid"))) ? f.lines[O] < 1 ? p.push(-20) : f.lines[O] > 1 ? p.push(b) : p.push(-10) : d(n, "liquid_bad_start") ? (b = b + 1, p.push(b)) : d(O, "liquid_bad_end") ? (b = b - 1, p.push(b)) : d(O, "liquid_else") && p[n - 1] === b ? p.push(b - 1) : d(n, "liquid_else") && p[n - 1] === b && e.markup.forceIndent === !1 ? (p[n - 1] = b - 1, p.push(b)) : d(l, "liquid_start") && d(O, "liquid_end") && f.lines[O] === 0 ? p[n - 1] = -20 : d(n, "liquid_case_start") ? (le.has("case") === !1 && (b = b + 1), p.push(b)) : d(n, "liquid_when") && d(O, "liquid_when") === !1 ? (d(l, "attribute") && e.markup.forceIndent === !1 ? p[n - 1] = b - 1 : b = b + 1, p.push(b)) : d(O, "liquid_when") && d(n, "liquid_when") === !1 ? (b = b - 1, p.push(b)) : (d(O, "liquid_case_end") && le.has("case") === !1 && (b = b - 1), p.push(b))), d(n, "content") === !1 && d(n, "singleton") === !1 && d(n, "liquid") === !1 && d(n, "liquid_when") === !1 && d(n, "attribute") === !1 && (o = 0)) : (o = 0, we()), n = n + 1;
    while (n < t);
    return p;
  }
  function me() {
    ...
    do {
      if (se === 0)
        if (se + 1 === oe - 1 && (P[se + 1].length === 2 || P[se + 1].length === 3)) {
          ee.length > 1 && (ee = ee.slice(0, -2)), D.push(P[se], ee, P[se + 1]);
          break;
        } else
          D.push(P[se], ee);
      else
        se === oe - 1 ? D.push(P[se]) : (se + 1 === oe - 1 && (P[se + 1].length === 2 || P[se + 1].length === 3) && (ee = ee.slice(0, -2)), D.push(P[se], ee));
      se = se + 1;
    } while (se < oe);
  }
  function ie() {
    ...
    do
      P[se] !== c ? (isNaN(ee) || (D.push(ee === 0 ? H : H.repeat(ee)), ee = NaN), P[se].startsWith(oe) || (P[se] = oe + P[se])) : isNaN(ee) || (ee = ee + 1), se = se + 1;
    while (se < T);
    ee = -1;
    do {
      if (se = se - 1, P[se] !== c)
    ...
    if (ee === -1)
      D.push(P.join(r.crlf).replace(ei, c)), D.push(C(S[n]));
    else {
      let _ = P.join(r.crlf).replace(ei, c).replace(Pe, c);
      ee === 0 ? D.push(_, C(S[n])) : D.push(_, H.repeat(ee), C(S[n]));
    }
  }
  function ce() {
    if (ct.test(f.token[n])) {
      ...
      do
        P[oe] === c ? oe + 1 !== T && P[oe + 1] !== c ? D.push(H, C(S[n], !1, !0)) : D.push(H) : oe + 1 === T ? D.push(P[oe], H, C(S[n], !1, !0)) : D.push(P[oe], H, C(S[n], !1, !0)), oe = oe + 1;
      while (oe < T);
    } else
      D.push(f.token[n], C(S[n]));
  }
  function J() {
    n = r.start, u = e.indentLevel, D.length === 0 && u > 0 && D.push(C(S[n], !1, !0));
    do {
      if (f.lexer[n] === "markup")
        n < t - 1 && (d(n, "start") || d(n, "singleton") || d(n, "xml")) && W(n, "attribute") < 0 && Ge(f.types[n + 1]) === !1 && W(n + 1, "attribute") > -1 && R(), d(n, "comment") && i(f.token[n].trimStart()[1], 37) && e.liquid.preserveComment === !0 ? (D.push(f.token[n]), (d(n + 1, "comment") && i(f.token[n + 1].trimStart()[1], 37) && e.liquid.preserveComment === !0) === !1 ? D.push(C(S[n])) : D.push(C(S[n], !0, !1))) : d(n, "comment") && i(f.token[n].trimStart()[1], 33) && e.markup.preserveComment === !0 ? D.push(f.token[n]) : Ge(f.token[n]) === !1 && f.token[n].indexOf(r.crlf) > 0 && (d(n, "content") && e.markup.preserveText === !1 || d(n, "comment") && M(f.token[n].trimStart()[1], 33) || d(n, "attribute")) ? U() : d(n, "comment") ? ce() : d(n, "liquid_capture") ? D.push(f.token[n], C(S[n])) : d(n, "ignore") ? a(n, "script") || a(n, "style") ? ie() : (D.push(f.token[n]), d(n + 1, "ignore") === !1 ? d(n + 1, "ignore_next") ? D.push(C(S[n], !0, !1)) : D.push(C(S[n])) : D.push(C(S[n], !0, !1))) : e.markup.forceIndent === !1 && d(n, "liquid") && d(n + 1, "end") && f.lines[n] === 0 ? D.push(f.token[n]) : (u = S[n], e.markup.delimiterTerminus === "force" && G(), ct.test(f.token[n]) && W(n, "liquid") > -1 && d(n, "liquid_end") === !1 ? me() : D.push(f.token[n]), S[n] === -10 && n < t - 1 ? D.push(te) : S[n] > -1 && (d(n, "ignore") === !1 && d(n + 1, "ignore_next") === !0 || d(n, "ignore") === !1 && d(n, "ignore_next") === !1 && d(n + 1, "ignore") === !0 && a(n + 1, "script") === !1 && a(n + 1, "style") === !1 ? D.push(C(S[n], !0, !1)) : d(n, "ignore") && d(n + 1, "ignore") === !1 && d(n + 1, "ignore_next") === !1 ? D.push(C(S[n])) : d(n + 1, "comment") && e.markup.preserveComment === !0 && Hi(f.token[n + 1].trimStart()[1], 33, 37) ? D.push(C(S[n], !0, !1)) : d(n + 1, "ignore") === !1 && d(n + 1, "ignore_next") === !1 && (e.markup.preserveText === !0 && d(n + 1, "content") ? D.push(C(S[n], !0, !1)) : D.push(C(S[n])))));
      else {
        r.start = n, r.ender = h[n], u > 0 && e.liquid.dedentTagList.includes(f.stack[n]) && (D.splice(D.length - 1, 1, C(S[n] - 1)), u = u - 1);
        let P = r.external(u);
        (e.language === "jsx" || e.language === "tsx") && (f.types[n - 1] === "template_string_end" || f.types[n - 1] === "jsx_attribute_start" || f.types[n - 1] === "script_start") ? D.push(P) : (D.push(P), (e.markup.forceIndent || S[r.iterator] > -1 && n in h) && (h[n] > n && (n = r.iterator), D.push(C(S[n])))), n !== r.iterator && (n = r.iterator);
      }
      n = n + 1;
    } while (n < t);
    return r.iterator = t - 1, e.endNewline === !0 ? D.join(c).replace(/\s*$/, r.crlf) : D.join(c).trimEnd();
  }
  return J();
}
...
function dn() {
  let { data: e, rules: s } = r, n = r.language === "json" ? s.json : s.script, N = 0, l = {}, O = "script", o = r.ender < 1 || r.ender > e.token.length ? e.token.length : r.ender + 1, b = (() => {
    let t = r.start, h = s.indentLevel, F = !1, le = !1, m = c, p = c, S = e.types[0], I = e.token[0], D = [-1], d = [], a = r.start > 0 ? Array(r.start).fill(0, 0, r.start) : [], g = [], W = [[]], C = [], U = [], j = [], x = [!1], R = [], G = [];
    function B() {
      V(!1, !1);
      ...
      if (e.types[t - 1] === "comment" || e.types[t + 1] === "comment")
        ...
        i(e.token[t - 1], 44) ? a[t - 1] = _ : i(I, 61) && e.types[t - 1] !== "comment" && /^\/\*{2}\s*@[A-Za-z_]+/.test(p) === !0 ? a[t - 1] = -10 : i(I, 123) && e.types[t - 1] !== "comment" && e.lines[0] < 2 ? e.stack[t] === "function" ? a[t - 1] = _ : a[t - 1] = /\n/.test(p) ? _ : -10 : a[t - 1] = _;
    ...
    function V(_, Q) {
      let k = t - 1, K = _ === !0 ? 0 : 1, y = W[W.length - 1] === void 0 ? [] : W[W.length - 1], w = Q === !1 && e.stack[t] === "array" && _ === !0 && M(p, 91);
        ...
        do {
          ...
          if (K === 0) {
            if (e.stack[t] === "class" || e.stack[t] === "map" || w === !1 && (_ === !1 && e.token[k] !== "(" && e.token[k] !== "x(" || _ === !0 && i(e.token[k], 44)))
              e.types[k + 1] === "liquid_start" ? e.lines[k] < 1 ? a[k] = -20 : a[k] = h - 1 : y.length > 0 && y[y.length - 1] > -1 ? a[k] = h - 1 : a[k] = h;
          ...
          if (K < 0) {
            e.types[k + 1] === "liquid_start" || e.types[k + 1] === "template_string_start" ? e.lines[k] < 1 ? a[k] = -20 : a[k] = h - 1 : y.length > 0 && y[y.length - 1] > -1 ? a[k] = h - 1 : a[k] = h;
            break;
          }
          k = k - 1;
        } while (k > -1);
    ...
    function ke() {
      let _ = Ge(W[W.length - 1]) ? [] : W[W.length - 1];
      function Q() {
        let k = t, K = !1, y = e.begin[k];
        do {
          if (k = k - 1, e.lexer[k] === "markup") {
            K = !0;
            break;
          }
          e.begin[k] !== y && (k = e.begin[k]);
        } while (k > y);
        if (K === !0) {
          k = t;
          do
            k = k - 1, e.begin[k] !== y ? k = e.begin[k] : i(e.token[k], 44) && (a[k] = h + 1);
          while (k > y);
          a[y] = h + 1, a[t - 1] = h;
        } else
          a[t - 1] = -20;
      ...
      if (i(p, 41) && i(e.token[t + 1], 46) && M(e.token[_[0]], 58) && _[_.length - 1] > -1) {
        ...
        K === !1 && y === !0 && W.length > 1 && (W[W.length - 2].push(e.begin[t]), h = h + 1);
      }
      if (S !== "separator" && L(), i(e.token[t + 1], 58) && (e.stack[t] === "object" || e.stack[t] === "array") && V(!0, !1), i(e.token[e.begin[t] - 1], 44) && (i(e.token[t + 1], 125) || i(e.token[t + 1], 93)) && (e.stack[t] === "object" || e.stack[t] === "array") && V(!0, !1), e.stack[t] !== "attribute" && (M(p, 41) && p !== "x)" && (e.lexer[t - 1] !== "markup" || e.lexer[t - 1] === "markup" && e.token[t - 2] !== "return") && (h = h - 1), i(p, 125) && e.stack[t] === "switch" && n.noCaseIndent === !1 && (h = h - 1)), i(p, 125) || p === "x}") {
        if (e.types[t - 1] !== "comment" && I !== "{" && I !== "x{" && S !== "end" && S !== "string" && S !== "number" && S !== "separator" && I !== "++" && I !== "--" && (t < 2 || e.token[t - 2] !== ";" || e.token[t - 2] !== "x;" || I === "break" || I === "return")) {
          let k = t - 1, K = !1, y = e.begin[t], w = d.length;
          do {
            if (e.begin[k] === y) {
              if ((i(e.token[k], 61) || i(e.token[k], 59) || e.token[k] === "x;") && (K = !0), i(e.token[k], 46) && a[k - 1] > -1) {
                U[U.length - 1] = !1, a[y] = h + 1, a[t - 1] = h;
                break;
              }
      ...
      if (n.bracePadding === !1 && p !== "}" && p !== "]" && S !== "markup" && S !== "liquid" && (a[t - 1] = -20), n.bracePadding === !0 && S !== "start" && I !== ";" && (a[e.begin[t]] < -9 || U[U.length - 1] === !0))
        ...
        let k = p === ")" && M(I, 40) && G.length > 0 ? G.pop() + 1 : 0, K = e.token[e.begin[t] - 1] === "if" ? (() => {
          let y = t;
          do
            if (y = y - 1, e.token[y] === ")" && a[y - 1] > -1)
              return k;
          while (y > e.begin[t]);
          return k + 5;
        })() : k;
        if (k > 0 && (r.language !== "jsx" || r.language === "jsx" && e.token[e.begin[t] - 1] !== "render")) {
          let y = s.wrap, w = e.begin[t], A = G.length, v = t - 2;
          if (K > y) {
          ...
          let y = e.begin[t] < 0 ? 0 : e.begin[t], w = s.wrap, A = _.length, v = 0, $ = 0, ge = 0, ne = 0, pe = 0, q = !1, E = !1, z = h + 1, Y = !1, Z = !1, fe = !1;
          if (a[y] < -9) {
            $ = y;
            do
              $ = $ + 1;
            ...
            ne = $;
            do
              v = v + e.token[$].length, a[$] === -10 && (v = v + 1), e.token[$] === "(" && ge > 0 && ge < w - 1 && ne === t && (ge = -1), e.token[$] === ")" ? pe = pe - 1 : e.token[$] === "(" && (pe = pe + 1), $ === y && pe > 0 && (ge = v), $ = $ - 1;
            while ($ > y && a[$] < -9);
            if (e.token[$ + 1] === "." && (z = a[$] + 1), v > w - 1 && w > 0 && M(I, 40) && ge !== -1 && U[U.length - 2] === !1 && (e.token[y - 1] === "if" && d[d.length - 1] === !0 || e.token[y - 1] !== "if") && (a[y] = z, e.token[y - 1] === "for")) {
              $ = y;
              do
                $ = $ + 1, i(e.token[$], 59) && e.begin[$] === y && (a[$] = z);
              while ($ < t);
            }
          }
          $ = t, v = 0;
          do
            $ = $ - 1, e.stack[$] === "function" ? $ = e.begin[$] : e.begin[$] === y ? (i(e.token[$], 63) ? fe = !0 : i(e.token[$], 44) && q === !1 ? (q = !0, v >= w && w > 0 && (Y = !0)) : e.types[$] === "markup" && Z === !1 && (Z = !0), a[$] > -9 && M(e.token[$], 44) && e.types[$] !== "markup" ? v = 0 : (a[$] === -10 && (v = v + 1), v = v + e.token[$].length, v >= w && w > 0 && (q === !0 || Z === !0) && (Y = !0))) : a[$] > -9 ? v = 0 : (v = v + e.token[$].length, v >= w && w > 0 && (q === !0 || Z === !0) && (Y = !0));
          while ($ > y && Y === !1);
          if (q === !1 && i(e.token[e.begin[t] + 1], 96))
            a[e.begin[t]] = -20, a[t - 1] = -20;
          else if ((q === !0 || Z === !0) && v >= w && w > 0 || a[y] > -9) {
            if (fe === !0) {
              if (z = a[y], i(e.token[y - 1], 91)) {
                $ = t;
                do
            ...
            do
              if ($ = $ - 1, e.begin[$] === y)
                if (e.token[$].indexOf("=") > -1 && e.types[$] === "operator" && e.token[$].indexOf("!") < 0 && e.token[$].indexOf("==") < 0 && e.token[$] !== "<=" && e.token[$].indexOf(">") < 0) {
                  ...
                  i(e.token[$], 44) ? a[$] = z : a[$] > -9 && E === !1 && (e.token[y - 1] !== "for" || e.token[$ + 1] === "?" || e.token[$ + 1] === ":") && (e.token[e.begin[t]] !== "(" || e.token[$] !== "+") && (a[$] = a[$] + 1);
              else
                a[$] > -9 && E === !1 && (a[$] = a[$] + 1);
            while ($ > y);
            a[y] = z, a[t - 1] = z - 1;
      ...
      e.types[t - 1] !== "comment" && (i(I, 123) && i(p, 125) || i(I, 91) && i(p, 93)))
        a[t - 1] = -20, a.push(-20);
      else if (i(p, 93)) {
        if (d[d.length - 1] === !0 && U[U.length - 1] === !1 && n.arrayFormat !== "inline" || i(I, 93) && a[t - 2] === h + 1 ? (a[t - 1] = h, a[e.begin[t]] = h + 1) : a[t - 1] === -10 && (a[t - 1] = -20), e.token[e.begin[t] + 1] === "function")
          a[t - 1] = h;
        ...
        i(p, 125) || p === "x}" || d[d.length - 1] === !0 ? (i(p, 125) && I === "x}" && e.token[t + 1] === "else" ? (a[t - 2] = h + 2, a.push(-20)) : a.push(h), a[t - 1] = h) : a.push(-20);
      e.types[t - 1] === "comment" && (a[t - 1] = h), we(), le = d[d.length - 1], d.pop(), W.pop(), C.pop(), j.pop(), R.pop(), U.pop(), x.pop();
    }
    function we() {
    ...
    function ye() {
      (e.token[t + 1] !== "," && p.indexOf("/>") !== p.length - 2 || e.token[t + 1] === "," && e.token[e.begin[t] - 3] !== "React") && V(!1, !1), I === "return" || I === "?" || I === ":" ? (a[t - 1] = -10, a.push(-20)) : S === "start" || e.token[t - 2] === "return" && e.stack[t - 1] === "method" ? a.push(h) : a.push(-20);
    }
    function me() {
      let _ = Ge(W[W.length - 1]) ? [] : W[W.length - 1];
      function Q() {
        let k = e.token[t + 1], K = 0, y = 0, w = t, A = p === "+" ? h + 2 : h, v = 0;
        if (s.wrap < 1) {
          a.push(-10);
          return;
        }
        ...
        if (v > 0 && (v = v + k.length), K = K + k.length, y = w, K > s.wrap - 1 && a[w] < -9)
          do
            y = y - 1;
          while (y > 0 && a[y] < -9);
        if (e.token[y + 1] === "." && e.begin[t] <= e.begin[y] ? A = A + 1 : e.types[y] === "operator" && (A = a[y]), y = k.length, K + y < s.wrap) {
          a.push(-10);
          return;
        }
        ...
        do {
          if (e.begin[K] === y) {
            ...
            if (e.token[K] === "?" || i(e.token[K], 58)) {
              e.token[_[_.length - 1]] === "." && k < 2 && (_[_.length - 1] = y + 1);
              break;
            }
            e.token[K] === "." && (k = k + 1);
          }
      ...
      if (p === "*") {
        I === "function" || I === "yield" ? a[t - 1] = -20 : a[t - 1] = -10, a.push(-10);
        return;
      }
      if (p === "?") {
      ...
      if (p === ":") {
        ...
        if ((i(I, 41) || I === "x)") && e.token[e.begin[t - 1] - 2] === "function") {
          a[t - 1] = -20, a.push(-10);
          return;
        }
        ...
        if (e.token[e.begin[t]] !== "(" && e.token[e.begin[t]] !== "x(" && (S === "reference" || i(I, 41) || i(I, 93) || I === "?") && (e.stack[t] === "map" || e.stack[t] === "class" || e.types[t + 1] === "reference") && (g.length === 0 || g[g.length - 1] < e.begin[t]) && ("mapclassexpressionmethodglobalparen".indexOf(e.stack[t]) > -1 || e.types[t - 2] === "word" && e.stack[t] !== "switch")) {
          a[t - 1] = -20, a.push(-10);
          return;
        }
      ...
      if (e.types[t - 1] !== "comment" && (i(I, 40) ? a[t - 1] = -20 : p === "*" && e.stack[t] === "object" && e.types[t + 1] === "reference" && (i(I, 123) || i(I, 44)) ? a[t - 1] = h : (p !== "?" || g.length === 0) && (a[t - 1] = -10)), p.indexOf("=") > -1 && p !== "==" && p !== "===" && p !== "!=" && p !== "!==" && p !== ">=" && p !== "<=" && p !== "=>" && e.stack[t] !== "method" && e.stack[t] !== "object") {
        let k = t + 1, K = 0, y = !1, w = c;
        if ((i(e.token[e.begin[t]], 40) || e.token[e.begin[t]] === "x(") && e.token[t + 1] !== "function")
          return;
        do {
          if (e.types[k] === "start") {
            if (y === !0 && e.token[k] !== "[") {
              x[x.length - 1] === !0 && (x[x.length - 1] = !1);
              break;
            }
            K = K + 1;
          }
          ...
          if (K === 0) {
            if (w = e.token[k], y === !0) {
              if (e.types[k] === "operator" || i(e.token[k], 59) || e.token[k] === "x;" || e.token[k] === "?" || e.token[k] === "var" || e.token[k] === "let" || e.token[k] === "const") {
                w !== void 0 && (w === "?" || w.indexOf("=") > -1 && w !== "==" && w !== "===" && w !== "!=" && w !== "!==" && w !== ">=" && w !== "<=") && x[x.length - 1] === !1 && (x[x.length - 1] = !0), (w === ";" || w === "x;" || w === "var" || w === "let" || w === "const") && x[x.length - 1] === !0 && (x[x.length - 1] = !1);
                break;
              }
              x[x.length - 1] === !0 && (w === "return" || w === "break" || w === "continue" || w === "throw") && (x[x.length - 1] = !1);
            }
            (w === ";" || w === "x;" || w === ",") && (y = !0);
          }
          k = k + 1;
      ...
      if (p === "-" && I === "return" || i(I, 61)) {
        a.push(-20);
        return;
      }
      if (S === "operator" && e.types[t + 1] === "reference" && I !== "--" && I !== "++" && p !== "&&" && p !== "||") {
        a.push(-20);
        return;
      }
      return Q();
    ...
    function ie() {
      ...
      if (e.types[t - 1] === "comment" ? a[t - 1] = h : S === "end" && I !== ")" && e.token[e.begin[t - 1] - 1] !== ")" ? a[t - 1] = -10 : S !== "separator" && S !== "start" && S !== "end" && S.indexOf("template_string") < 0 && (S === "word" || S === "operator" || S === "property" || S === "type" || S === "reference" ? a[t - 1] = -10 : a[t - 1] = -20), I === "var" && e.lexer[t - 1] === O)
        _();
      else if (I === "function")
        r.stack.push([e.token[t], t]);
      else if (I === "let" || I === "const")
        r.stack.push([e.token[t], t]);
    ...
    function ce() {
      let _ = Ge(W[W.length - 1]) ? [] : W[W.length - 1], Q = () => {
        if (n.methodChain > 0) {
          let k = t, K = e.begin[t], y = [t], w = e.token[K - 1] === "if";
          do
      ...
      if (p === ",") {
        ...
        if (S === "reference" && e.types[t - 2] === "word" && "var-let-const-from".indexOf(e.token[t - 2]) < 0 && (e.types[t - 3] === "end" || e.token[t - 3] === ";")) {
          R[R.length - 1] = !0, a.push(-10);
          return;
        }
        if (R[R.length - 1] === !0 || e.stack[t] === "notation") {
          a.push(-10);
          return;
        }
        ...
        if (U[U.length - 1] === !1 || i(e.token[t - 2], 43) && (S === "string" || S === "number") && a[t - 2] > 0 && (i(I, 34) || i(I, 39))) {
          if (e.stack[t] === "method") {
            if (i(e.token[t - 2], 43) && (i(I, 34) || i(I, 39)) && (e.token[t - 3].charAt(0) === '"' || e.token[t - 3].charAt(0) === "'")) {
              a.push(h + 2);
              return;
            }
            if (e.token[t - 2] !== "+") {
      ...
      if (i(p, 59) || p === "x;") {
        ...
        if (D[D.length - 1] > -1 && e.stack[D[D.length - 1]] !== "expression") {
          let k = t;
          do {
        ...
        if (D[D.length - 1] = -1, we(), e.token[e.begin[t] - 1] !== "for" && V(!1, !1), R[R.length - 1] = !1, a[t - 1] = -20, e.begin[t] > 0 && e.token[e.begin[t] - 1] === "for" && e.stack[t] !== "for") {
          a.push(-10);
          return;
        }
        a.push(h);
    ...
    function J() {
      ...
      if ((i(I, 41) || M(I, 93) && (Q === "object" || Q === "array")) && (_ !== "method" || _ === "method" && M(e.token[t + 1], 41) && M(e.token[t + 2], 41)) && (i(I, 41) && (_ !== "function" || i(e.token[e.begin[e.begin[t - 1] - 1]], 40) || e.token[e.begin[e.begin[t - 1] - 1]] === "x(") ? V(!1, !1) : e.types[t + 1] !== "end" && e.types[t + 2] !== "end" && V(!0, !1)), d.push(!1), W.push([]), x.push(!1), C.push(!1), R.push(!1), j.push(0), n.neverFlatten === !0 || _ === "attribute" || S === "generic" || n.arrayFormat === "indent" && _ === "array" || _ === "class" && M(I, 40) && I !== "x(" || i(p, 91) && e.token[t + 1] === "function" ? U.push(!1) : _ === "expression" || _ === "method" || (_ === "object" || _ === "class") && (i(I, 40) || I === "x(" || S === "word" || S === "reference") || _ === "array" || i(p, 40) || p === "x(" || i(p, 123) && _ === "object" && S !== "operator" && S !== "start" && S !== "string" && S !== "number" && Q !== "object" && Q !== "array" && t > 0 ? U.push(!0) : U.push(!1), M(p, 40) && p !== "x(" && e.stack[t + 1] !== "attribute" && (h = h + 1), i(p, 123) || p === "x{") {
        if (D.push(-1), e.types[t - 1] !== "comment" && (S === "markup" ? a[t - 1] = h : n.braceAllman === !0 && S !== "operator" && I !== "return" ? a[t - 1] = h - 1 : e.stack[t + 1] !== "block" && (_ === "function" || i(I, 41) || I === "x)" || i(I, 44) || i(I, 125) || S === "markup") ? a[t - 1] = -10 : (i(I, 123) || I === "x{" || i(I, 91) || i(I, 125) || I === "x}") && (a[t - 1] = h - 1)), _ === "object") {
      ...
      if (i(p, 40) || p === "x(") {
        if (s.wrap > 0 && i(p, 40) && e.token[t + 1] !== ")" && G.push(1), i(I, 45) && (i(e.token[t - 2], 40) || e.token[t - 2] === "x(") && (a[t - 2] = -20), S === "end" && Q !== "if" && Q !== "for" && Q !== "catch" && Q !== "else" && Q !== "do" && Q !== "try" && Q !== "finally" && Q !== "catch" && (e.types[t - 1] === "comment" ? a[t - 1] = h : a[t - 1] = -20), I === "async" ? a[t - 1] = -10 : (_ === "method" || e.token[t - 2] === "function" && S === "reference") && (I === "import" || I === "in" || n.functionNameSpace === !0 ? a[t - 1] = -10 : i(I, 125) && e.stack[t - 1] === "function" || S === "word" || S === "reference" || S === "property" ? a[t - 1] = -20 : Q !== "method" && _ !== "method" && (a[t - 1] = h)), i(I, 43) && (i(e.token[t - 2], 34) || i(e.token[t - 2], 39))) {
          a.push(h);
          return;
        }
        if (i(I, 125) || I === "x}") {
        ...
        (i(I, 45) && (t < 2 || M(e.token[t - 2], 41) && M(e.token[t - 2], 93) && e.token[t - 2] !== "x)" && e.types[t - 2] !== "reference" && e.types[t - 2] !== "string" && e.types[t - 2] !== "number") || n.functionSpace === !1 && I === "function") && (a[t - 1] = -20), a.push(-20);
        return;
      }
      if (i(p, 91)) {
        if (i(I, 91) && (d[d.length - 2] = !0), I === "return" || I === "var" || I === "let" || I === "const" ? a[t - 1] = -10 : e.types[t - 1] !== "comment" && e.stack[t - 1] !== "attribute" && (S === "end" || S === "word" || S === "reference") ? a[t - 1] = -20 : (i(I, 91) || i(I, 123) || I === "x{") && (a[t - 1] = h - 1), e.stack[t] === "attribute") {
          a.push(-20);
          return;
        }
    ...
    function ee() {
      if ((i(I, 41) || I === "x)") && e.stack[t] === "class" && (e.token[e.begin[t - 1] - 1] === "static" || e.token[e.begin[t - 1] - 1] === "final" || e.token[e.begin[t - 1] - 1] === "void") && (a[t - 1] = -10, a[e.begin[t - 1] - 1] = -10), i(I, 93) && (a[t - 1] = -10), p === "else" && i(I, 125) && (e.token[t - 2] === "x}" && (a[t - 3] = a[t - 3] - 1), (n.braceAllman === !0 || n.elseNewline === !0) && (a[t - 1] = h)), p === "new" && Le.js.keywords.has(e.token[t + 1]) && (N = N + 1), p === "from" && S === "end" && t > 0 && (e.token[e.begin[t - 1] - 1] === "import" || i(e.token[e.begin[t - 1] - 1], 44)) && (a[t - 1] = -10), p === "function") {
      ...
      } else if (p === "in" || (i(I, 125) || I === "x}") && (p === "catch" || p === "else" && n.elseNewline === !1 && n.braceAllman === !1))
        a[t - 1] = -10;
      else if (p === "var" || p === "let" || p === "const") {
        if (D[D.length - 1] = t, S === "end" && (a[t - 1] = h), e.token[e.begin[t] - 1] !== "for") {
          let _ = t + 1, Q = 0;
          do {
      ...
      if (e.stack[t] === "object" && (i(I, 123) || i(I, 44)) && (i(e.token[t + 1], 40) || e.token[t + 1] === "x(")) {
        a.push(-20);
        return;
      }
      e.types[t - 1] === "comment" && i(e.token[e.begin[t]], 40) && (a[t - 1] = h + 1), s.script.inlineReturn === !0 && p === "return" && S === "start" && e.stack[t] === "if" && I === "x{" ? (a[t - 1] = -20, a.push(-20)) : a.push(-10);
    }
    do
      e.lexer[t] === O ? (m = e.types[t], p = e.token[t], m === "comment" ? B() : m === "regex" ? a.push(-20) : m === "string" ? P() : m.indexOf("template_string") === 0 ? oe() : m === "separator" ? ce() : m === "start" ? J() : m === "end" ? ke() : m === "type" || m === "type_start" || m === "type_end" ? se() : m === "operator" ? me() : m === "word" ? ee() : m === "reference" ? ie() : m === "markup" ? ye() : m.indexOf("liquid") > -1 ? T() : m === "generic" ? (M(I, 35) && I !== "return" && S !== "operator" && I !== "public" && I !== "private" && I !== "static" && I !== "final" && I !== "implements" && I !== "class" && I !== "void" && (a[t - 1] = -20), i(e.token[t + 1], 40) || e.token[t + 1] === "x(" ? a.push(-20) : a.push(-10)) : a.push(-10), m !== "comment" && (S = m, I = p), G.length > 0 && M(e.token[t], 41) && (e.types[t] === "comment" && G[G.length - 1] > -1 ? G[G.length - 1] = s.wrap + 1 : a[t] > -1 || i(e.token[t], 96) && e.token[t].indexOf(H) > 0 ? G[G.length - 1] = -1 : G[G.length - 1] > -1 && (G[G.length - 1] = G[G.length - 1] + e.token[t].length, a[t] === -10 && (G[G.length - 1] = G[G.length - 1] + 1)))) : ae(), t = t + 1;
    while (t < o);
    return a;
  })();
  return (() => {
    ...
    function S(D) {
      ...
      return r.crlf.repeat(d) + h.repeat(D);
    }
    if (n.vertical === !0) {
      let D = function(d) {
        let a = 0, g = 0, W = d - 1, C = 0, U = 0, j = e.begin[m], x = [];
        do {
        ...
        if (W = x.length, W > 0)
          do
            if (W = W - 1, C = x[W][1], C < a)
              do
                e.token[x[W][0]] = e.token[x[W][0]] + te, C = C + 1;
              while (C < a);
          while (W > 0);
      };
      m = o;
      do
        m = m - 1, e.lexer[m] === "script" && i(e.token[m], 125) && M(e.token[m - 1], 123) && b[e.begin[m]] > 0 ? D(m) : m = e.begin[m];
      while (m > 0);
    }
    m = r.start;
    do {
      if (e.lexer[m] === O) {
        if (e.types[m] === "comment" && n.commentIndent === !0 && ct.test(e.token[m])) {
          let D = e.begin[m] > -1 ? i(e.token[m][2], 42) ? ai(b[m], h) + s.indentChar : ai(b[m], h) : s.indentChar, d = e.token[m].split(H), a = 1;
          do
            d[a] = D + d[a].trimStart(), a = a + 1;
          while (a < d.length);
          e.token.splice(m, 1, d.join(H));
        }
        le.indexOf(e.token[m]) < 0 && (M(e.token[m], 59) || n.noSemicolon === !1 ? t.push(e.token[m]) : b[m] < 0 && e.types[m + 1] !== "comment" && t.push(";")), m < o - 1 && e.lexer[m + 1] !== O && e.begin[m] === e.begin[m + 1] && e.types[m + 1].indexOf("end") < 0 && M(e.token[m], 44) ? t.push(te) : b[m] > -1 ? ((b[m] > -1 && i(e.token[m], 123) || b[m] > -1 && i(e.token[m + 1], 125)) && e.lines[m] < 3 && n.braceNewline === !0 && e.lines[m + 1] < 3 && t.push(S(0)), r.mode === 2 ? r.ender !== m && t.push(S(b[m])) : m !== o - 1 && t.push(S(b[m])), p = b[m]) : b[m] === -10 && (t.push(te), e.lexer[m + 1] !== O && (p = p + 1));
      } else if (l[m] === m)
        t.push(e.token[m]);
      else {
        r.ender = l[m], r.start = m;
        let D = r.external(p);
        t.push(D), m = r.iterator, b[m] === -10 ? t.push(te) : b[m] > -1 && t.push(S(b[m]));
      }
      m = m + 1;
    } while (m < o);
...
var Ci = class extends Array {
   ...
   */
  reset() {
    this.error = null, this.count = -1, this.start = 0, this.ender = 0, this.lineColumn = 0, this.lineNumber = 1, this.lineDepth = 2, this.lineIndex = 0, this.lineOffset = 0, this.numbers = [], this.data.begin = [], this.data.ender = [], this.data.lexer = [], this.data.lines = [], this.data.stack = [], this.data.token = [], this.data.types = [], this.references = [[]], this.stack = new Ci(["global", -1]), this.mode = 1, this.pairs = Fe(null), this.attributes.size > 0 && this.attributes.clear(), this.regions.size > 0 && this.regions.clear();
  }
  /**
   * Get Record
   *
   ...
   */
  document(s, n = 3) {
    return ii.test(this.source) ? this.source : (this.reset(), wi(s), n === 1 ? this.data : (this.mode = 3, Li(s)));
  }
  /**
   * Switch
   *
  ...
  external(s, n) {
    if (this.mode === 1) {
      this.mode = 2;
      let u = Ct(s);
      it.region = n, this.language = s, this.lexer = Ie(this.language), this.regions.set(this.count + 1, { lexer: u, id: this.language }), wi(u), this.mode = 1, this.lexer = Ie(this.rules.language), this.language = this.rules.language;
    } else {
      ...
      let l = Li(N);
      return this.mode = 3, this.rules.indentLevel = 0, this.language = this.rules.language, this.lexer = Ie(this.language), l;
    }
  }
  /**
   * Push Final
...
function bn(e, s) {
  let n = Gi(e), u = n("preset") ? Rn(e) : e, N;
  s.rules.length > 0 && (N = {}), n("language") && Jt("global", "language", u.language) && r.language !== u.language && (r.language = r.rules.language = u.language);
  for (let l of On)
    n(l) !== !1 && r.rules[l] !== u[l] && Jt("global", l, u[l]) && (N && (N[l] = { from: r.rules[l], to: u[l] }), l === "crlf" && (r.crlf = u[l] ? Ri : H), l === "wrap" && u[l] > 0 && (n("wrapFraction") === !1 || n("wrapFraction") && u.wrapFraction <= 0) && (u.wrapFraction = u[l] - u[l] / 4), r.rules[l] = u[l]);
  for (let l of vn)
...
var kn = new class {
  ...
  format(s, n) {
    ...
    let u = Ct(this.language), N = Re.reportStats ? li(this.language, this.lexer) : null, l = r.document(u);
    if (r.error !== null)
  ...
  parse(s, n) {
    ...
    let u = Ct(this.language), N = Re.reportStats ? li(this.language, this.lexer) : null, l = r.document(u, 1);
    if (r.error !== null)
      if (this.events.error.length > 0) {
        for (let o of this.events.error)
          o(r.error);
  ...
  rules(s) {
    return Ge(s) ? r.rules : (bn(s, this.events), this.language = r.language, this.lexer = r.lexer = Ie(r.language), r.rules);
  }
  liquid(s, n) {
